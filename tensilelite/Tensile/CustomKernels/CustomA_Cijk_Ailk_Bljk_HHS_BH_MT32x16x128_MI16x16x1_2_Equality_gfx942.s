...
v_readfirstlane_b32 s51, v[vgprSerial]             // WaveIdxWavefrontWidth
s_lshr_b32 s51, s51, 0x6                           // WaveId
s_mul_i32 s51, s51, 8                              // Each wave loads continuous lsp(2)*nrp(4) columns
...
s_cbranch_scc0 label_NoBranch_I811LZV24EHL2KZB_0   // Only branch on scc1
...
label_NoBranch_I811LZV24EHL2KZB_0:
...
ds_write_b64 v[vgprLocalWriteAddrB], v[vgprG2LB+4:vgprG2LB+4+1] offset:1152 // lwoB_0_0_2_0 = (0*LSCB)*(MT1J+PAD) + (2*LSPB) = 1152
ds_write_b64 v[vgprLocalWriteAddrB], v[vgprG2LB+6:vgprG2LB+6+1] offset:1728 // lwoB_0_0_3_0 = (0*LSCB)*(MT1J+PAD) + (3*LSPB) = 1728
...
label_Summation_End_EQ3F156X3XS3H2HX_0:
s_setprio 0                                        // optimization store
/* endSummation: add vgpr [0...78) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_LWFRIHIX5Z2RYC9O_0   // Only branch on scc1
...
label_NoBranch_LWFRIHIX5Z2RYC9O_0:
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v11, v6, v10, s[66:67]               // 1. mul 1 if 0
buffer_load_dwordx4 v[136:139], v11, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v14, v6, v13, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[136:139], v14, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v17, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[136:139], v18, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
