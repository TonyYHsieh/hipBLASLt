...
s_mov_b32 m0, 0x3d00                               // LDS clamp at 15616 bytes
...
v_mov_b32 v12, s71                                 // edge vgpr = Size0I- WG*MT - margin(4)
...
s_cbranch_scc0 label_NoBranch_QFA9JTAGYJXAMAM0_0   // Only branch on scc1
...
label_NoBranch_QFA9JTAGYJXAMAM0_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[46:47], v[vgprG2LA+1+0] src0_sel:WORD_0 // convert to F32
...
v_cvt_pk_f32_fp8 v[46:47], v[vgprG2LA+1+0] src0_sel:WORD_1 // convert to F32
...
v_cvt_pk_f32_fp8 v[46:47], v[vgprG2LA+3+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+2+0], v46 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+2+0], v47 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[46:47], v[vgprG2LA+3+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+2+1], v46 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+2+1], v47 dst_sel:WORD_1  // Convert to FP16
...
ds_write_b128 v[vgprLocalWriteAddrB], v[vgprG2LB+4:vgprG2LB+4+3] offset:320 // lwoB_0_0_1_0 = (0*LSCB)*(MT1J+PAD) + (1*LSPB) = 320
...
label_Summation_End_EFNBF2Q85GA0NFIN_0:
/* endSummation: add vgpr [0...44) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_QS7HDEF3RDT2MF3A_0   // Only branch on scc1
...
label_NoBranch_QS7HDEF3RDT2MF3A_0:
