...
s_mov_b32 m0, 0xb400                               // LDS clamp at 46080 bytes
...
s_mov_b32 s73, 4096                                // LSU offset: stride = lsuStride(128)*(MT0(32) + PAD0(0))
...
s_mul_i32 s73, s73, 32                             // Each wave loads continuous lsp(16)*nrp(2) columns
...
s_cbranch_scc0 label_NoBranch_1WNPW51ALCQBKJSM_0   // Only branch on scc1
...
label_NoBranch_1WNPW51ALCQBKJSM_0:
...
s_cbranch_scc1 label_NoBranch_MTFTBT2I6GOKMY5T_0   // Only branch on scc0
s_getpc_b64 s[74:75]                               // addr of next instr
s_add_i32 s76, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s74, s74, s76                            // add target branch offset
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_MTFTBT2I6GOKMY5T_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_SQEPA2NHFBUQ0ATO_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[74:75]                               // addr of next instr
s_add_i32 s76, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s74, s74, s76                            // add target branch offset
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_SQEPA2NHFBUQ0ATO_0:
...
s_cbranch_scc0 label_NoBranch_TYFF80OKY8JRDMQA_0   // Only branch on scc1
...
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_TYFF80OKY8JRDMQA_0:
...
s_cbranch_scc0 label_NoBranch_9H2NNUJ2SHP3DGOL_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[74:75]                               // addr of next instr
s_add_i32 s76, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s74, s74, s76                            // add target branch offset
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_9H2NNUJ2SHP3DGOL_0:

s_and_b32 s75, 127, s[sgprSizesSum+0]              // s75 = s[sgprSizesSum+0] % 128
s_cmp_eq_u32 s75, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_16VGA3NP11DIKRD6_0   // Only branch on scc0
...
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_16VGA3NP11DIKRD6_0:
...
label_Summation_End_S7Z5QVNGMMZ3COU3_0:
/* endSummation: add vgpr [0...122) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_7N8S7P9LDEPNTL7G_0   // Only branch on scc1
...
label_NoBranch_7N8S7P9LDEPNTL7G_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
