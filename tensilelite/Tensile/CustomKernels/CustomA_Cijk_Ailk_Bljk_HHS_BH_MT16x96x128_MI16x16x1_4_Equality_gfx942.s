...
s_mul_i32 s51, s51, 64                             // Each wave loads continuous lsp(32)*nrp(2) columns
...
/* max read offset = size[n] * stride[n-1] */
s_mul_hi_u32 s85, s[sgprWorkGroup1], 96            // WorkGroup[01] * MT
s_mul_i32 s84, s[sgprWorkGroup1], 96               // WorkGroup[01] * MT
...
buffer_load_dwordx4 v[vgprG2LB+32:vgprG2LB+32+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+7] offen offset:0, sc0 // G -> Reg 0_0_8_0
buffer_load_dwordx4 v[vgprG2LB+36:vgprG2LB+36+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+8] offen offset:0, sc0 // G -> Reg 0_0_9_0
buffer_load_dwordx4 v[vgprG2LB+40:vgprG2LB+40+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+9] offen offset:0, sc0 // G -> Reg 0_0_10_0
buffer_load_dwordx4 v[vgprG2LB+44:vgprG2LB+44+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+10] offen offset:0, sc0 // G -> Reg 0_0_11_0
...
s_cbranch_scc0 label_NoBranch_YAIIV26TCG68BLQX_0   // Only branch on scc1
...
label_NoBranch_YAIIV26TCG68BLQX_0:
...
s_waitcnt lgkmcnt(15)                              // wait for prior local read local write old=4, new=18 newLW=14 newLR=0
/* pack scheduling: packAIdx:2, packBIdx:0 */
...
s_mov_b32 s85, 0x0                                 // STATIC_DIV: divisior=96
s_mul_i32 s84, 0x555, s[sgprSizeJ]                 // tmp1 = dividend * magic hi
s_lshl_b64 s[84:85], s[84:85], 0x10                // left shift 16 bits
s_mul_i32 s83, s[sgprSizeJ], 0x5556                // tmp0 = dividend * magic lo
...
s_mul_i32 s84, s83, 0x60                           // quotient*divisor
...
buffer_load_dword v[vgprG2LA+4+0], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+0] offen offset:0 // load packed 2X half buffer value
/* g2l=4, load component 2 */
buffer_load_dword v[vgprG2LA+4+1], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+0] offen offset:4 // load packed 2X half buffer value
/* g2l=4, load component 4 */
buffer_load_dword v[vgprG2LA+4+2], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+0] offen offset:8 // load packed 2X half buffer value
/* g2l=4, load component 6 */
buffer_load_dword v[vgprG2LA+4+3], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+0] offen offset:12 // load packed 2X half buffer value
...
buffer_load_dword v[vgprG2LB+32+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+7] offen offset:0, sc0 // load packed 2X half buffer value
/* g2l=32, load component 2 */
buffer_load_dword v[vgprG2LB+32+1], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+7] offen offset:4, sc0 // load packed 2X half buffer value
/* g2l=32, load component 4 */
buffer_load_dword v[vgprG2LB+32+2], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+7] offen offset:8, sc0 // load packed 2X half buffer value
/* g2l=32, load component 6 */
buffer_load_dword v[vgprG2LB+32+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+7] offen offset:12, sc0 // load packed 2X half buffer value
/* g2l=36, load component 0 */
buffer_load_dword v[vgprG2LB+36+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+8] offen offset:0, sc0 // load packed 2X half buffer value
/* g2l=36, load component 2 */
buffer_load_dword v[vgprG2LB+36+1], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+8] offen offset:4, sc0 // load packed 2X half buffer value
/* g2l=36, load component 4 */
buffer_load_dword v[vgprG2LB+36+2], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+8] offen offset:8, sc0 // load packed 2X half buffer value
/* g2l=36, load component 6 */
buffer_load_dword v[vgprG2LB+36+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+8] offen offset:12, sc0 // load packed 2X half buffer value
/* g2l=40, load component 0 */
buffer_load_dword v[vgprG2LB+40+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+9] offen offset:0, sc0 // load packed 2X half buffer value
/* g2l=40, load component 2 */
buffer_load_dword v[vgprG2LB+40+1], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+9] offen offset:4, sc0 // load packed 2X half buffer value
/* g2l=40, load component 4 */
buffer_load_dword v[vgprG2LB+40+2], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+9] offen offset:8, sc0 // load packed 2X half buffer value
/* g2l=40, load component 6 */
buffer_load_dword v[vgprG2LB+40+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+9] offen offset:12, sc0 // load packed 2X half buffer value
/* g2l=44, load component 0 */
buffer_load_dword v[vgprG2LB+44+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+10] offen offset:0, sc0 // load packed 2X half buffer value
/* g2l=44, load component 2 */
buffer_load_dword v[vgprG2LB+44+1], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+10] offen offset:4, sc0 // load packed 2X half buffer value
/* g2l=44, load component 4 */
buffer_load_dword v[vgprG2LB+44+2], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+10] offen offset:8, sc0 // load packed 2X half buffer value
/* g2l=44, load component 6 */
buffer_load_dword v[vgprG2LB+44+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+10] offen offset:12, sc0 // load packed 2X half buffer value
...
/* Tail: add address/G2L vgpr [80...142) to pool */
...
/* Tail: remove address/G2L [80...142) from pool */
label_Summation_End_LJ4EV2G3R3RR8KN0_0:
/* endSummation: add vgpr [0...142) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_CFLWA36QQ1J03P5Q_0   // Only branch on scc1
...
label_NoBranch_CFLWA36QQ1J03P5Q_0:
