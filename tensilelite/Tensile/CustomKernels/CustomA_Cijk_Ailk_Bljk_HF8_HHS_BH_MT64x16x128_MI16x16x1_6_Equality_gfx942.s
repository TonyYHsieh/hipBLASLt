...
s_mul_i32 s51, s51, 4                              // Each wave loads continuous lsp(2)*nrp(2) columns
...
buffer_load_dword v[vgprG2LB+1], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // G -> Reg 0_0_0_0
buffer_load_dword v[vgprG2LB+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:0 // G -> Reg 0_0_1_0
...
s_cbranch_scc0 label_NoBranch_PZFJ530KF7LWZJ6Y_0   // Only branch on scc1
...
label_NoBranch_PZFJ530KF7LWZJ6Y_0:
...
/* local write b */
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LB+1+0] src0_sel:WORD_0 // convert to F32
...
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LB+1+0] src0_sel:WORD_1 // convert to F32
...
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LB+3+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+2+0], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+2+0], v77 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LB+3+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+2+1], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+2+1], v77 dst_sel:WORD_1  // Convert to FP16
ds_write_b64 v[vgprLocalWriteAddrB], v[vgprG2LB+2:vgprG2LB+2+1] offset:576 // lwoB_0_0_1_0 = (0*LSCB)*(MT1J+PAD) + (1*LSPB) = 576
...
/* global read B */
/* g2l=0, load component 0 */
buffer_load_ubyte_d16 v[vgprG2LB+1+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // load one buffer value
...
buffer_load_ubyte_d16 v[vgprG2LB+3+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:0 // load one buffer value
...
s_waitcnt vmcnt(2)
v_lshlrev_b32 v0, 0x8, v0                          // shift left to higher 8 bits
v_or_b32 v[vgprG2LB+3+0], v[vgprG2LB+3+0], v0      // pack a sub 8-bit with dest
s_waitcnt vmcnt(1)
v_or_b32 v[vgprG2LB+3+0], v[vgprG2LB+3+0], v1      // pack a sub 8-bit with dest
s_waitcnt vmcnt(0)
v_lshlrev_b32 v2, 0x8, v2                          // shift left to higher 8 bits
v_or_b32 v[vgprG2LB+3+0], v[vgprG2LB+3+0], v2      // pack a sub 8-bit with dest
...
ds_write_b64 v[vgprLocalWriteAddrB], v[vgprG2LB+0:vgprG2LB+0+1] offset:0 // lwoB_0_0_0_0 = (0*LSCB)*(MT1J+PAD) + (0*LSPB) = 0
v_cvt_pk_f32_fp8 v[0:1], v[vgprG2LB+3+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+2+0], v0 dst_sel:WORD_0   // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+2+0], v1 dst_sel:WORD_1   // Convert to FP16
v_cvt_pk_f32_fp8 v[0:1], v[vgprG2LB+3+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+2+1], v0 dst_sel:WORD_0   // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+2+1], v1 dst_sel:WORD_1   // Convert to FP16
ds_write_b64 v[vgprLocalWriteAddrB], v[vgprG2LB+2:vgprG2LB+2+1] offset:576 // lwoB_0_0_1_0 = (0*LSCB)*(MT1J+PAD) + (1*LSPB) = 576
...
label_Summation_End_NKURPJNJ3BOZE91N_0:
/* endSummation: add vgpr [0...74) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_G5YJSF97ZGQ834JB_0   // Only branch on scc1
...
label_NoBranch_G5YJSF97ZGQ834JB_0:
