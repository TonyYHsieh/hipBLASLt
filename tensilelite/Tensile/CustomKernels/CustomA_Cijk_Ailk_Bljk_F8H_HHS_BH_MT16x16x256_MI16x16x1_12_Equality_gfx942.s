...
s_mul_i32 s51, s51, 256                            // Each wave loads continuous lsp(32)*nrp(8) columns
...
v_mov_b32 v24, s70                                 // edge vgpr = Size0I- WG*MT - margin(8)
...
s_mul_hi_u32 s71, 256, s[sgprGSUSumIdx]            // gsuOffset = DepthU*bpeGR*GSUSumIdx
s_mul_i32 s70, 256, s[sgprGSUSumIdx]               // gsuOffset = DepthU*bpeGR*GSUSumIdx
...
s_cbranch_scc0 label_NoBranch_O0ERWXK5LGE921HE_0   // Only branch on scc1
...
label_NoBranch_O0ERWXK5LGE921HE_0:
...
s_and_b32 s71, 255, s[sgprSizesSum+0]              // s71 = s[sgprSizesSum+0] % 256
...
v_cmp_ge_i32 s[70:71], v96, s[sgprLoopCounterL]    // check K index >= Size L
...
v_cmp_lt_i32 s[70:71], v96, 4                      // set partial 0 if distance less than input per thread
...
v_lshlrev_b64 v[98:99], s72, v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+0], v[vgprValuA_X0_I0+0+0+0+0], v98, s[70:71]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+1], v[vgprValuA_X0_I0+0+0+0+1], v99, s[70:71]
v_lshlrev_b64 v[98:99], s72, v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+0], v[vgprValuB_X0_I0+0+0+0+0], v98, s[70:71]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0+1], v99, s[70:71]
s_nop 1
v_mfma_f32_16x16x16_f16 acc[0:3], v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1], acc[0:3] // left value = acc[0+0:3+0]
...
label_Summation_End_6VDVJCI562RWMID7_0:
/* endSummation: add vgpr [0...180) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_8G61GVA6PESZO90C_0   // Only branch on scc1
...
label_NoBranch_8G61GVA6PESZO90C_0:
