...
s_cbranch_scc0 label_NoBranch_1086CA96AT75YHWE_0   // Only branch on scc1
...
label_NoBranch_1086CA96AT75YHWE_0:
...
/* local write b */
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+2+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+0+0], v88 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+0+0], v89 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+2+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+0+1], v88 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+0+1], v89 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+0+2], v88 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+0+2], v89 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+0+3], v88 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+0+3], v89 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrB], v[vgprG2LB+0:vgprG2LB+0+3] offset:0 // lwoB_0_0_0_0 = (0*LSCB)*(MT1J+PAD) + (0*LSPB) = 0
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+6+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+4+0], v88 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+4+0], v89 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+6+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+4+1], v88 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+4+1], v89 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+6+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+4+2], v88 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+4+2], v89 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+6+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+4+3], v88 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+4+3], v89 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrB], v[vgprG2LB+4:vgprG2LB+4+3] offset:1152 // lwoB_0_0_1_0 = (0*LSCB)*(MT1J+PAD) + (1*LSPB) = 1152
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+10+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+8+0], v88 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+8+0], v89 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+10+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+8+1], v88 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+8+1], v89 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+10+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+8+2], v88 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+8+2], v89 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+10+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+8+3], v88 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+8+3], v89 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrB], v[vgprG2LB+8:vgprG2LB+8+3] offset:2304 // lwoB_0_0_2_0 = (0*LSCB)*(MT1J+PAD) + (2*LSPB) = 2304
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+14+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+12+0], v88 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+12+0], v89 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+14+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+12+1], v88 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+12+1], v89 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+14+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+12+2], v88 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+12+2], v89 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[88:89], v[vgprG2LB+14+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+12+3], v88 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+12+3], v89 dst_sel:WORD_1 // Convert to FP16
...
/* Tail: add address/G2L vgpr [48...86) to pool */
...
/* Tail: remove address/G2L [48...86) from pool */
label_Summation_End_CBM68LA4OV27VZMY_0:
s_setprio 0                                        // optimization store
/* endSummation: add vgpr [0...86) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_ZF8TQ03TV5VLG8B6_0   // Only branch on scc1
...
label_NoBranch_ZF8TQ03TV5VLG8B6_0:
