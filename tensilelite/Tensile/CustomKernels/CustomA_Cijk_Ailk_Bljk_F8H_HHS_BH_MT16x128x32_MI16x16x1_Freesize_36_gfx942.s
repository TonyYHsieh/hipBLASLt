...
s_cbranch_scc0 label_NoBranch_US3GPNZQ747O1PT7_0   // Only branch on scc1
...
label_NoBranch_US3GPNZQ747O1PT7_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[36:37], v[vgprG2LA+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0], v36 dst_sel:WORD_0    // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0], v37 dst_sel:WORD_1    // Convert to FP16
...
label_Summation_End_RP52GLOFWBI2GJCU_0:
/* endSummation: add vgpr [0...34) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_QYUZE8MMYRBGY8I8_0   // Only branch on scc1
...
label_NoBranch_QYUZE8MMYRBGY8I8_0:
