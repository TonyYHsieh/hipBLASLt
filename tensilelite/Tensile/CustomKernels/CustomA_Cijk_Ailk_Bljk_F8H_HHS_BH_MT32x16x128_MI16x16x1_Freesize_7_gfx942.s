...
s_cbranch_scc0 label_NoBranch_HCFB4LNTMYWJDJVB_0   // Only branch on scc1
...
label_NoBranch_HCFB4LNTMYWJDJVB_0:
...
label_Summation_End_RW7VSSHFMK88MCLZ_0:
/* endSummation: add vgpr [0...82) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_X491PRBA4SHO7FNM_0   // Only branch on scc1
...
label_NoBranch_X491PRBA4SHO7FNM_0:
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v140, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
