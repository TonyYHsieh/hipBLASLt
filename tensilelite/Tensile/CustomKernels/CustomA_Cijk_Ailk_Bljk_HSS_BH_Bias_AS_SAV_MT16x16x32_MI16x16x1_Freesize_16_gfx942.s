...
s_mov_b32 m0, 0x1940                               // LDS clamp at 6464 bytes
...
s_mul_i32 s71, s71, 16                             // Each wave loads continuous lsp(8)*nrp(2) columns
...
v_add_co_u32 v8, vcc, 8, v7                        // groB1J_1 += LSPB

/* global read addresses: unroll offsets a */
v_mov_b32 v9, v1                                   // groAL_0
v_add_co_u32 v10, vcc, 1, v9                       // groAL_1 + LSPA
...
v_mov_b32 v29, s71                                 // edge vgpr = Size0I- WG*MT - margin(4)
v_min_i32 v6, v29, v6                              // offset = (offset < edge) ? offset(v6) : edge(v29)

/* global read addresses: final offsets a */
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+0,  6,  9, 29 // gROA_0_0_0_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+1,  6, 10, 29 // gROA_0_0_1_0

/* global read addresses: final offsets b */
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+0, 11,  7, 29 // gROB_0_0_0_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+1, 11,  8, 29 // gROB_0_0_1_0
...
s_cbranch_scc0 label_NoBranch_T5VAPLL2RYAPVPZR_0   // Only branch on scc1
...
label_NoBranch_T5VAPLL2RYAPVPZR_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
ds_write_b64 v[vgprLocalWriteAddrA], v[vgprG2LA+0:vgprG2LA+0+1] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
ds_write_b64 v[vgprLocalWriteAddrA], v[vgprG2LA+2:vgprG2LA+2+1] offset:32 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 32
...
s_cbranch_scc1 label_NoBranch_1VSVKNASMLAX1YAF_0   // Only branch on scc0
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_1VSVKNASMLAX1YAF_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_F98ZU2QE52BJ3N3Z_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_F98ZU2QE52BJ3N3Z_0:
...
s_cbranch_scc0 label_NoBranch_90S3K3V307MEHN9T_0   // Only branch on scc1
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_90S3K3V307MEHN9T_0:
...
s_cbranch_scc0 label_NoBranch_F02HNXS72C6XZ9EP_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_F02HNXS72C6XZ9EP_0:

s_and_b32 s73, 31, s[sgprSizesSum+0]               // s73 = s[sgprSizesSum+0] % 32
s_cmp_eq_u32 s73, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_G1PXO997FX5C2WO4_0   // Only branch on scc0
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_G1PXO997FX5C2WO4_0:
...
/* endSummation: add vgpr [0...28) to pool */
/* load store sgprs */
...
/* Tail: add address/G2L vgpr [12...28) to pool */
...
/* Tail: remove address/G2L [12...28) from pool */
label_Summation_End_7Q1WSN6DP3WEAY4R_0:
/* endSummation: add vgpr [0...28) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_422XRW06MNIGLKXR_0   // Only branch on scc1
...
label_NoBranch_422XRW06MNIGLKXR_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
...
v_cndmask_b32 v24, v38, v24, s[76:77]              // LDTD clip if OOB. offset
...
v_add_f32 v4, v27, v[vgprValuC+30]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v30, v4
buffer_store_dword v30, v24, s[sgprSrdTD:sgprSrdTD+3], 0 offen offset:0, sc0 sc1 // store TD not StoreRemapVectorWidth
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
...
v_cndmask_b32 v25, v42, v25, s[76:77]              // LDC clip if OOB. offset
buffer_load_dword v30, v25, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
s_mul_i32 s72, 16, s[sgprWorkGroup0]               // wgp0 * MT0
v_sub_u32 v27, v4, s72
v_lshlrev_b32 v27, 0x2, v27                        // Bias address scaled by BPE
v_cndmask_b32 v27, v42, v27, s[76:77]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v25, v42, v25, s[76:77]              // LDD clip if OOB. offset
v_add_lshl_u32 v26, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v26, v42, v26, s[76:77]              // LDTD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,3) */
v_add_co_u32 v4, vcc, v0, 3                        // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[72:73], v4, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[76:77], v1, s[sgprSizeJ]            // coord1 < size1
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v43, v25, v42, s[80:81]              // 1. mul 1 if 0
buffer_load_dword v44, v43, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cndmask_b32 v27, v34, v27, s[76:77]              // LDD clip if OOB. offset
...
v_cndmask_b32 v24, v38, v24, s[76:77]              // LDBias clip if OOB. offset
ds_read_b32 v27, v24 offset:0                      // load bias
v_lshlrev_b32 v25, 0x2, v4                         // ScaleAlphaVec address scaled by BPE
buffer_load_dword v29, v25, s[sgprSrdScaleAlphaVec:sgprSrdScaleAlphaVec+3], 0 offen offset:0 // load scaleAlphaVecI
v_add_lshl_u32 v23, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v23, v38, v23, s[76:77]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,3) */
v_add_co_u32 v4, vcc, v0, 3                        // coord0.1: coord0 += d0*sg0*VW + vc0
...
v_cndmask_b32 v29, 1.0, v29, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+30], v29, v[vgprValuC+30]    // *= scaleAlphaVecVMul
v_fmac_f32 v[vgprValuC+30], v26, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_add_f32 v4, v27, v[vgprValuC+30]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v30, v4
