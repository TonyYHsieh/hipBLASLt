...
s_cbranch_scc0 label_NoBranch_E4RVAMMEDOTTE8GO_0   // Only branch on scc1
...
label_NoBranch_E4RVAMMEDOTTE8GO_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[32:33], v[vgprG2LA+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0], v32 dst_sel:WORD_0    // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0], v33 dst_sel:WORD_1    // Convert to FP16
ds_write_b32 v[vgprLocalWriteAddrA], v[vgprG2LA+0] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
v_cvt_pk_f32_fp8 v[32:33], v[vgprG2LA+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+1], v32 dst_sel:WORD_0    // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+1], v33 dst_sel:WORD_1    // Convert to FP16
...
label_Summation_End_OC0LNOB7C72AJUOW_0:
/* endSummation: add vgpr [0...30) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_648JSWNVZEGSVZUW_0   // Only branch on scc1
...
label_NoBranch_648JSWNVZEGSVZUW_0:
...
v_cndmask_b32 v6, v31, v6, s[56:57]                // LDD clip if OOB. offset
v_add_lshl_u32 v7, v3, v0, 0x1                     // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v7, v31, v7, s[56:57]                // LDTD clip if OOB. offset
...
v_cndmask_b32 v9, v31, v9, s[56:57]                // LDD clip if OOB. offset
v_add_lshl_u32 v10, v3, v4, 0x1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v10, v31, v10, s[56:57]              // LDTD clip if OOB. offset
...
v_cndmask_b32 v12, v31, v12, s[56:57]              // LDD clip if OOB. offset
v_add_lshl_u32 v13, v3, v4, 0x1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v13, v31, v13, s[56:57]              // LDTD clip if OOB. offset
...
v_cndmask_b32 v15, v31, v15, s[56:57]              // LDD clip if OOB. offset
v_add_lshl_u32 v16, v3, v4, 0x1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v16, v31, v16, s[56:57]              // LDTD clip if OOB. offset
...
v_cndmask_b32 v18, v31, v18, s[56:57]              // LDD clip if OOB. offset
v_add_lshl_u32 v19, v3, v4, 0x1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v19, v31, v19, s[56:57]              // LDTD clip if OOB. offset
...
v_cndmask_b32 v21, v31, v21, s[56:57]              // LDD clip if OOB. offset
v_add_lshl_u32 v22, v3, v4, 0x1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v22, v31, v22, s[56:57]              // LDTD clip if OOB. offset
...
v_cndmask_b32 v24, v31, v24, s[56:57]              // LDD clip if OOB. offset
v_add_lshl_u32 v25, v3, v4, 0x1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v25, v31, v25, s[56:57]              // LDTD clip if OOB. offset
...
v_cndmask_b32 v27, v31, v27, s[56:57]              // LDD clip if OOB. offset
v_add_lshl_u32 v28, v3, v4, 0x1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v28, v31, v28, s[56:57]              // LDTD clip if OOB. offset
v_accvgpr_read_b32 v[vgprValuC+8], acc0            // copy acc to vreg[0]
...
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v36, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v44, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v52, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v60, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v68, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v76, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v84, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v92, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v100, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v108, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v116, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v124, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v132, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v140, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v6, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v148, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
...
s_addc_u32 s65, s65, s59
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v9, v31, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v36, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s65, s65, s59
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v12, v31, s[60:61]              // 1. mul 1 if 0
buffer_load_dword v36, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s65, s65, s59
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v15, v31, s[60:61]              // 1. mul 1 if 0
buffer_load_dword v36, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s65, s65, s59
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v18, v31, s[60:61]              // 1. mul 1 if 0
buffer_load_dword v36, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s65, s65, s59
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v21, v31, s[60:61]              // 1. mul 1 if 0
buffer_load_dword v36, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s65, s65, s59
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v24, v31, s[60:61]              // 1. mul 1 if 0
buffer_load_dword v36, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s65, s65, s59
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v32, v27, v31, s[60:61]              // 1. mul 1 if 0
buffer_load_dword v36, v32, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
buffer_store_dwordx4 v[32:35], v6, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D 0
buffer_store_dwordx4 v[36:39], v6, s[sgprSrdD:sgprSrdD+3], 0 offen offset:16, sc0 sc1 // store D 0
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
...
buffer_load_dwordx4 v[36:39], v6, s[60:63], 0 offen offset:16, sc0 sc1 // load GSU D 0
s_mov_b32 s[sgprGSUSync], s[sgprGSU]
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 0
s_add_u32 s60, s60, s54
s_addc_u32 s61, s61, s55
...
v_fma_mix_f32 v[vgprValuC+36], s[sgprBeta], v18, v[vgprValuC+36] op_sel:[0,0,0] op_sel_hi:[0,1,0] // //C*=beta
v_fma_mix_f32 v[vgprValuC+37], s[sgprBeta], v18, v[vgprValuC+37] op_sel:[0,1,0] op_sel_hi:[0,1,0] // //C*=beta
v_fma_mix_f32 v[vgprValuC+38], s[sgprBeta], v19, v[vgprValuC+38] op_sel:[0,0,0] op_sel_hi:[0,1,0] // //C*=beta
v_fma_mix_f32 v[vgprValuC+39], s[sgprBeta], v19, v[vgprValuC+39] op_sel:[0,1,0] op_sel_hi:[0,1,0] // //C*=beta
...
buffer_store_dwordx4 v[32:35], v7, s[sgprSrdTD:sgprSrdTD+3], 0 offen offset:0, sc0 sc1 // store TD not StoreRemapVectorWidth
// synchronizer store
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
...
v_cndmask_b32 v31, v39, v31, s[56:57]              // LDC clip if OOB. offset
buffer_load_short_d16 v33, v31, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_add_lshl_u32 v31, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v31, v39, v31, s[56:57]              // LDD clip if OOB. offset
v_add_lshl_u32 v32, v3, v4, 0x1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v32, v39, v32, s[56:57]              // LDTD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,7) */
v_add_co_u32 v4, vcc, v0, 7                        // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[52:53], v4, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[56:57], v1, s[sgprSizeJ]            // coord1 < size1
...
buffer_store_dword v34, v31, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D 6
...
s_mov_b32 s66, s[sgprSrdD+2]
s_mov_b32 s67, s[sgprSrdD+3]
buffer_load_dword v34, v31, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU D 0
s_mov_b32 s[sgprGSUSync], s[sgprGSU]
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 0
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
...
s_addc_u32 s65, s65, s59
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v40, v31, v39, s[60:61]              // 1. mul 1 if 0
buffer_load_dword v44, v40, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
// synchronizer store
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
v_fma_mix_f32 v[vgprValuC+34], s[sgprBeta], v33, v[vgprValuC+34] op_sel:[0,0,0] op_sel_hi:[0,1,0] // //C*=beta
v_cvt_f16_f32 v34, v[vgprValuC+34]                 // convert C to fp16
buffer_store_short v34, v32, s[sgprSrdTD:sgprSrdTD+3], 0 offen offset:0, sc0 sc1 // store TD not StoreRemapVectorWidth
// synchronizer store
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
...
/* MultipleBufferSingleKernel edge */
v_add_lshl_u32 v6, v2, v0, 0x1                     // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v6, v31, v6, s[56:57]                // LDC clip if OOB. offset
...
v_cndmask_b32 v9, v31, v9, s[56:57]                // LDC clip if OOB. offset
...
v_cndmask_b32 v12, v31, v12, s[56:57]              // LDC clip if OOB. offset
...
v_cndmask_b32 v15, v31, v15, s[56:57]              // LDC clip if OOB. offset
...
/* MultipleBufferSingleKernel edge */
v_add_lshl_u32 v18, v2, v4, 0x1                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v18, v31, v18, s[56:57]              // LDC clip if OOB. offset
...
v_cndmask_b32 v21, v31, v21, s[56:57]              // LDC clip if OOB. offset
...
v_cndmask_b32 v24, v31, v24, s[56:57]              // LDC clip if OOB. offset
...
v_cndmask_b32 v27, v31, v27, s[56:57]              // LDC clip if OOB. offset
