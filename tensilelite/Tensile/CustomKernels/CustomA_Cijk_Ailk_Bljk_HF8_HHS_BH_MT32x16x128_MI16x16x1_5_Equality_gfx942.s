...
s_mov_b32 s51, 32                                  // LSU offset: stride = MT0(32) + PAD0(0)
...
v_readfirstlane_b32 s51, v[vgprSerial]             // WaveIdxWavefrontWidth
s_lshr_b32 s51, s51, 0x6                           // WaveId
s_mul_i32 s51, s51, 8                              // Each wave loads continuous lsp(4)*nrp(2) columns
...
s_sub_u32 s69, s[sgprNumWorkGroups1], s71          // WorkGroup1=remainder
...
s_cselect_b32 s70, s69, s[sgprWGM]
...
s_mul_i32 s69, s[sgprGSU], DepthU*BpeAGR
s_mul_i32 s[sgprGlobalReadIncsA+0], s69, s[sgprStrideAL] // incrA unrollIdx)

/* global read addresses: increments b */
s_mul_i32 s69, s[sgprGSU], DepthU*BpeBGR
s_mov_b32 s[sgprGlobalReadIncsB+0], s69            // incrB (unrollIdx)
...
buffer_load_dwordx2 v[vgprG2LB+6:vgprG2LB+6+1], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:0 // G -> Reg 0_0_1_0
...
s_mul_hi_u32 s72, s73, s[sgprStrideC1J]            // Free1
s_mul_i32 s69, s73, s[sgprStrideC1J]               // Free1
s_add_u32 s70, s70, s69                            // Free1
s_addc_u32 s71, s71, s72                           // Free1
s_sub_u32 s73, s[sgprSizesFree+2], 1               // Free2
s_mul_i32 s73, s73, s[sgprGSUSumIdx]               // Free2
s_mul_hi_u32 s72, s73, s[sgprStrideCK]             // Free2
s_mul_i32 s69, s73, s[sgprStrideCK]                // Free2
s_add_u32 s70, s70, s69                            // Free2
s_addc_u32 s71, s71, s72                           // Free2
...
s_cbranch_scc0 label_NoBranch_C6HOZ1REHN7EM42T_0   // Only branch on scc1
...
label_NoBranch_C6HOZ1REHN7EM42T_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+0] offset:0 // lwoA_0_0_0_0 = (0 + 0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+0] offset:256 // lwoA_0_1_0_0 = (1 + 0*LSCA) + (0*LSPA)(*MT0I+PAD) = 256
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+1] offset:544 // lwoA_0_2_0_0 = (2 + 0*LSCA) + (0*LSPA)(*MT0I+PAD) = 544
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+1] offset:800 // lwoA_0_3_0_0 = (3 + 0*LSCA) + (0*LSPA)(*MT0I+PAD) = 800
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+2] offset:1088 // lwoA_0_4_0_0 = (4 + 0*LSCA) + (0*LSPA)(*MT0I+PAD) = 1088
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+2] offset:1344 // lwoA_0_5_0_0 = (5 + 0*LSCA) + (0*LSPA)(*MT0I+PAD) = 1344
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+3] offset:1632 // lwoA_0_6_0_0 = (6 + 0*LSCA) + (0*LSPA)(*MT0I+PAD) = 1632
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+3] offset:1888 // lwoA_0_7_0_0 = (7 + 0*LSCA) + (0*LSPA)(*MT0I+PAD) = 1888
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+4] offset:32 // lwoA_0_0_1_0 = (0 + 0*LSCA) + (1*LSPA)(*MT0I+PAD) = 32
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+4] offset:288 // lwoA_0_1_1_0 = (1 + 0*LSCA) + (1*LSPA)(*MT0I+PAD) = 288
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+5] offset:576 // lwoA_0_2_1_0 = (2 + 0*LSCA) + (1*LSPA)(*MT0I+PAD) = 576
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+5] offset:832 // lwoA_0_3_1_0 = (3 + 0*LSCA) + (1*LSPA)(*MT0I+PAD) = 832
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+6] offset:1120 // lwoA_0_4_1_0 = (4 + 0*LSCA) + (1*LSPA)(*MT0I+PAD) = 1120
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+6] offset:1376 // lwoA_0_5_1_0 = (5 + 0*LSCA) + (1*LSPA)(*MT0I+PAD) = 1376
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+7] offset:1664 // lwoA_0_6_1_0 = (6 + 0*LSCA) + (1*LSPA)(*MT0I+PAD) = 1664
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+7] offset:1920 // lwoA_0_7_1_0 = (7 + 0*LSCA) + (1*LSPA)(*MT0I+PAD) = 1920
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+8] offset:64 // lwoA_0_0_2_0 = (0 + 0*LSCA) + (2*LSPA)(*MT0I+PAD) = 64
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+8] offset:320 // lwoA_0_1_2_0 = (1 + 0*LSCA) + (2*LSPA)(*MT0I+PAD) = 320
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+9] offset:608 // lwoA_0_2_2_0 = (2 + 0*LSCA) + (2*LSPA)(*MT0I+PAD) = 608
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+9] offset:864 // lwoA_0_3_2_0 = (3 + 0*LSCA) + (2*LSPA)(*MT0I+PAD) = 864
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+10] offset:1152 // lwoA_0_4_2_0 = (4 + 0*LSCA) + (2*LSPA)(*MT0I+PAD) = 1152
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+10] offset:1408 // lwoA_0_5_2_0 = (5 + 0*LSCA) + (2*LSPA)(*MT0I+PAD) = 1408
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+11] offset:1696 // lwoA_0_6_2_0 = (6 + 0*LSCA) + (2*LSPA)(*MT0I+PAD) = 1696
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+11] offset:1952 // lwoA_0_7_2_0 = (7 + 0*LSCA) + (2*LSPA)(*MT0I+PAD) = 1952
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+12] offset:96 // lwoA_0_0_3_0 = (0 + 0*LSCA) + (3*LSPA)(*MT0I+PAD) = 96
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+12] offset:352 // lwoA_0_1_3_0 = (1 + 0*LSCA) + (3*LSPA)(*MT0I+PAD) = 352
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+13] offset:640 // lwoA_0_2_3_0 = (2 + 0*LSCA) + (3*LSPA)(*MT0I+PAD) = 640
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+13] offset:896 // lwoA_0_3_3_0 = (3 + 0*LSCA) + (3*LSPA)(*MT0I+PAD) = 896
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+14] offset:1184 // lwoA_0_4_3_0 = (4 + 0*LSCA) + (3*LSPA)(*MT0I+PAD) = 1184
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+14] offset:1440 // lwoA_0_5_3_0 = (5 + 0*LSCA) + (3*LSPA)(*MT0I+PAD) = 1440
ds_write_b16 v[vgprLocalWriteAddrA], v[vgprG2LA+15] offset:1728 // lwoA_0_6_3_0 = (6 + 0*LSCA) + (3*LSPA)(*MT0I+PAD) = 1728
ds_write_b16_d16_hi v[vgprLocalWriteAddrA], v[vgprG2LA+15] offset:1984 // lwoA_0_7_3_0 = (7 + 0*LSCA) + (3*LSPA)(*MT0I+PAD) = 1984

/* local write b */
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+2+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+0+0], v64 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+0+0], v65 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+2+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+0+1], v64 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+0+1], v65 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+0+2], v64 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+0+2], v65 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+0+3], v64 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+0+3], v65 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrB], v[vgprG2LB+0:vgprG2LB+0+3] offset:0 // lwoB_0_0_0_0 = (0*LSCB)*(MT1J+PAD) + (0*LSPB) = 0
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+6+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+4+0], v64 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+4+0], v65 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+6+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+4+1], v64 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+4+1], v65 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+6+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+4+2], v64 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+4+2], v65 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+6+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+4+3], v64 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+4+3], v65 dst_sel:WORD_1  // Convert to FP16
...
v_xor_b32 v[vgprLocalWriteAddrB+0], 0x4000, v[vgprLocalWriteAddrB+0] // swap Red Blk
s_waitcnt lgkmcnt(15)                              // wait for prior local read local write old=0, new=36 newLW=34 newLR=2
...
/* localReadInitPointers */
s_waitcnt lgkmcnt(15)                              // wait for prior local read local write old=0, new=34 newLW=34 newLR=0
...
/* g2l=4, load component 0 */
buffer_load_ubyte_d16 v[vgprG2LB+6+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:0 // load one buffer value
...
/* g2l=4, load component 4 */
buffer_load_ubyte_d16 v[vgprG2LB+6+1], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:4 // load one buffer value
...
v_add_u32 v1, v2, v1                               // 6. offset in wave: lrOffset = bnOffset + lrKOffset
v_lshrrev_b32 v2, 7, v[vgprSerial]                 // LSU offset: sgid = Serial / subGroup(128)
s_mov_b32 s5, 32                                   // LSU offset: stride = MT0(32) + PAD0(0)
...
/* Tail: add address/G2L vgpr [32...62) to pool */
...
/* Tail: remove address/G2L [32...62) from pool */
label_Summation_End_6IOOBHPVQ1S18SQB_0:
/* endSummation: add vgpr [0...62) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_EE3JRE6BYGLZMT93_0   // Only branch on scc1
...
label_NoBranch_EE3JRE6BYGLZMT93_0:
