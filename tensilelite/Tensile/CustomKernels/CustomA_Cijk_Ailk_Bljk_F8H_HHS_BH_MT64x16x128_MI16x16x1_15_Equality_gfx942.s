...
s_cbranch_scc0 label_NoBranch_YLDJTLO1XW7U5CFP_0   // Only branch on scc1
...
label_NoBranch_YLDJTLO1XW7U5CFP_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+2+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+0], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+0], v77 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+2+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+1], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+1], v77 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+2], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+2], v77 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+3], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+3], v77 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+0:vgprG2LA+0+3] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+6+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+0], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+0], v77 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+6+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+1], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+1], v77 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+6+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+2], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+2], v77 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+6+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+3], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+3], v77 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+4:vgprG2LA+4+3] offset:512 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 512
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+10+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+0], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+0], v77 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+10+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+1], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+1], v77 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+10+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+2], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+2], v77 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+10+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+3], v76 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+3], v77 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+8:vgprG2LA+8+3] offset:1056 // lwoA_0_0_2_0 = (0*LSCA) + (2*LSPA)(*MT0I+PAD) = 1056
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+14+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+0], v76 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+0], v77 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+14+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+1], v76 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+1], v77 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+14+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+2], v76 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+2], v77 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[76:77], v[vgprG2LA+14+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+3], v76 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+3], v77 dst_sel:WORD_1 // Convert to FP16
...
label_Summation_End_F40GGC49JO91N3B0_0:
/* endSummation: add vgpr [0...74) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_9KL1GBS8CX3ASE7D_0   // Only branch on scc1
...
label_NoBranch_9KL1GBS8CX3ASE7D_0:
...
buffer_load_dwordx4 v[76:79], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[80:83], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[84:87], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[88:91], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[92:95], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[96:99], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[100:103], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[104:107], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[108:111], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[112:115], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[116:119], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[120:123], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[124:127], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[128:131], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v13, v6, v12, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx4 v[132:135], v13, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
...
buffer_load_dwordx4 v[76:79], v17, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
