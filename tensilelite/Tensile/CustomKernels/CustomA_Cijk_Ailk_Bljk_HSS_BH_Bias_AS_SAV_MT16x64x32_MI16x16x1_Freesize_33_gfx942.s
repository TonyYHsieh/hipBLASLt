...
s_mov_b32 m0, 0x3700                               // LDS clamp at 14080 bytes
...
v_mov_b32 v10, s71                                 // edge vgpr = Size0I- WG*MT - margin(2)
v_min_i32 v6, v10, v6                              // offset = (offset < edge) ? offset(v6) : edge(v10)

/* global read addresses: final offsets a */
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+0,  6,  8, 25 // gROA_0_0_0_0

/* global read addresses: final offsets b */
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+0,  9,  7, 25 // gROB_0_0_0_0
...
s_cbranch_scc0 label_NoBranch_RD7FOSLASXQQIMI3_0   // Only branch on scc1
...
label_NoBranch_RD7FOSLASXQQIMI3_0:
...
s_cbranch_scc1 label_NoBranch_QRT7BO52E5KQJ1IH_0   // Only branch on scc0
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_QRT7BO52E5KQJ1IH_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_KUKZFFVU5FGZ17OD_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_KUKZFFVU5FGZ17OD_0:
...
s_cbranch_scc0 label_NoBranch_XC4HFZCD9NVZBPBU_0   // Only branch on scc1
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_XC4HFZCD9NVZBPBU_0:
...
s_cbranch_scc0 label_NoBranch_0Z77UX5QX35R70YE_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_0Z77UX5QX35R70YE_0:

s_and_b32 s73, 31, s[sgprSizesSum+0]               // s73 = s[sgprSizesSum+0] % 32
s_cmp_eq_u32 s73, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_JWXBVXAKQKRF9X50_0   // Only branch on scc0
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_JWXBVXAKQKRF9X50_0:
...
/* endSummation: add vgpr [0...24) to pool */
/* load store sgprs */
...
/* Tail: add address/G2L vgpr [12...24) to pool */
...
/* Tail: remove address/G2L [12...24) from pool */
label_Summation_End_EKXSQ9O82KXZ798C_0:
/* endSummation: add vgpr [0...24) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_MWD6RXV1AAM3J7V7_0   // Only branch on scc1
...
label_NoBranch_MWD6RXV1AAM3J7V7_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
...
v_cndmask_b32 v23, v38, v23, s[76:77]              // LDD clip if OOB. offset
...
buffer_store_dword v30, v23, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D 2
...
s_mov_b32 s86, s[sgprSrdD+2]
s_mov_b32 s87, s[sgprSrdD+3]
buffer_load_dword v30, v23, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU D 0
s_mov_b32 s[sgprGSUSync], s[sgprGSU]
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 0
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v39, v23, v38, s[80:81]              // 1. mul 1 if 0
buffer_load_dword v40, v39, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v23, 1.0, v23, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+25], v23, v[vgprValuC+25]    // *= scaleAlphaVecVMul
...
buffer_load_dword v26, v23, s[sgprSrdScaleAlphaVec:sgprSrdScaleAlphaVec+3], 0 offen offset:0 // load scaleAlphaVecI
...
v_cndmask_b32 v23, v38, v23, s[76:77]              // LDC clip if OOB. offset
buffer_load_dword v27, v23, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
s_mul_i32 s72, 16, s[sgprWorkGroup0]               // wgp0 * MT0
...
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v30, v4
buffer_store_dword v30, v23, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D not StoreRemapVectorWidth
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v36, 1.0, v36, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+37], v36, v[vgprValuC+37]    // *= scaleAlphaVecVMul
