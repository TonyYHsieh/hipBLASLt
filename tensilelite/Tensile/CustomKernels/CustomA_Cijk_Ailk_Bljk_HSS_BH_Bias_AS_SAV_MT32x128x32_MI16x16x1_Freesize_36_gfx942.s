...
s_cbranch_scc0 label_NoBranch_SF5SRZE4KBKDGDGA_0   // Only branch on scc1
...
label_NoBranch_SF5SRZE4KBKDGDGA_0:
...
s_cbranch_scc1 label_NoBranch_X80OOEUTI6W8UGWM_0   // Only branch on scc0
s_getpc_b64 s[74:75]                               // addr of next instr
s_add_i32 s76, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s74, s74, s76                            // add target branch offset
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_X80OOEUTI6W8UGWM_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_UVRGJGRRD3XN5MUQ_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[74:75]                               // addr of next instr
s_add_i32 s76, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s74, s74, s76                            // add target branch offset
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_UVRGJGRRD3XN5MUQ_0:
...
s_cbranch_scc0 label_NoBranch_QRETV2PK11KCUN03_0   // Only branch on scc1
...
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_QRETV2PK11KCUN03_0:
...
s_cbranch_scc0 label_NoBranch_0Q9ZHQOLAEDN0HBP_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[74:75]                               // addr of next instr
s_add_i32 s76, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s74, s74, s76                            // add target branch offset
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_0Q9ZHQOLAEDN0HBP_0:

s_and_b32 s75, 31, s[sgprSizesSum+0]               // s75 = s[sgprSizesSum+0] % 32
s_cmp_eq_u32 s75, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_O2KBLJ3IMFV447U2_0   // Only branch on scc0
...
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_O2KBLJ3IMFV447U2_0:
...
v_accvgpr_read_b32 v[vgprValuC+49], acc14          // copy acc to vreg[13]
...
v_pk_add_f32 v[4:5], v[28:29], v[vgprValuC+40:vgprValuC+40+1] // C += bias
v_pk_add_f32 v[6:7], v[30:31], v[vgprValuC+42:vgprValuC+42+1] // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v40, v4
v_mov_b32 v41, v5
v_mov_b32 v42, v6
...
v_pk_add_f32 v[4:5], v[28:29], v[vgprValuC+48:vgprValuC+48+1] // C += bias
v_pk_add_f32 v[6:7], v[30:31], v[vgprValuC+50:vgprValuC+50+1] // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v48, v4
v_mov_b32 v49, v5
v_mov_b32 v50, v6
...
label_Summation_End_9XAUF4J0HL16P6TK_0:
/* endSummation: add vgpr [0...38) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_F785RAZHMJHV1KWT_0   // Only branch on scc1
...
label_NoBranch_F785RAZHMJHV1KWT_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
...
buffer_store_dwordx4 v[48:51], v9, s[sgprSrdD:sgprSrdD+3], 0 offen offset:16, sc0 sc1 // store D 3
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
...
v_cndmask_b32 v39, v106, v39, s[76:77]             // LDTD clip if OOB. offset
...
v_cndmask_b32 v47, v106, v47, s[76:77]             // LDBias clip if OOB. offset
...
v_cndmask_b32 v46, v106, v46, s[76:77]             // LDTD clip if OOB. offset
...
v_cndmask_b32 v54, v106, v54, s[76:77]             // LDBias clip if OOB. offset
...
v_cndmask_b32 v52, v106, v52, s[76:77]             // LDD clip if OOB. offset
v_add_lshl_u32 v53, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v53, v106, v53, s[76:77]             // LDTD clip if OOB. offset
...
v_cndmask_b32 v61, v106, v61, s[76:77]             // LDBias clip if OOB. offset
...
v_cndmask_b32 v59, v106, v59, s[76:77]             // LDD clip if OOB. offset
v_add_lshl_u32 v60, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v60, v106, v60, s[76:77]             // LDTD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,0,0) */
...
v_cndmask_b32 v66, v106, v66, s[76:77]             // LDD clip if OOB. offset
...
buffer_store_dword v44, v37, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D 4
...
buffer_store_dword v70, v66, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D 8
...
s_mov_b32 s86, s[sgprSrdD+2]
s_mov_b32 s87, s[sgprSrdD+3]
buffer_load_dword v44, v37, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU D 0
s_mov_b32 s[sgprGSUSync], s[sgprGSU]
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 0
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v107, v45, v106, s[80:81]            // 1. mul 1 if 0
buffer_load_dword v108, v107, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v107, v52, v106, s[80:81]            // 1. mul 1 if 0
buffer_load_dword v108, v107, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v107, v59, v106, s[80:81]            // 1. mul 1 if 0
buffer_load_dword v108, v107, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_mov_b32 s86, s[sgprSrdD+2]
s_mov_b32 s87, s[sgprSrdD+3]
buffer_load_dword v70, v66, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU D 0
s_mov_b32 s[sgprGSUSync], s[sgprGSU]
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 0
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v107, v66, v106, s[80:81]            // 1. mul 1 if 0
buffer_load_dword v108, v107, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v43, 1.0, v43, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+90], v43, v[vgprValuC+90]    // *= scaleAlphaVecVMul
v_add_f32 v4, v42, v[vgprValuC+90]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v90, v4
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v50, 1.0, v50, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+95], v50, v[vgprValuC+95]    // *= scaleAlphaVecVMul
v_add_f32 v4, v49, v[vgprValuC+95]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v95, v4
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v57, 1.0, v57, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+100], v57, v[vgprValuC+100]  // *= scaleAlphaVecVMul
v_add_f32 v4, v56, v[vgprValuC+100]                // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v100, v4
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v64, 1.0, v64, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+105], v64, v[vgprValuC+105]  // *= scaleAlphaVecVMul
v_add_f32 v4, v63, v[vgprValuC+105]                // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v105, v4
...
buffer_load_dwordx4 v[52:55], v11, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
/* (d1,vc1,d0,vc0)=(1,0,0,4) */
buffer_load_dwordx4 v[60:63], v11, s[sgprSrdC:sgprSrdC+3], 0 offen offset:16 // load C
v_add_lshl_u32 v9, v3, v0, 0x2                     // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
v_add_lshl_u32 v10, v3, v0, 0x2                    // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
...
v_accvgpr_read_b32 v[vgprValuC+57], acc12          // copy acc to vreg[9]
v_accvgpr_read_b32 v[vgprValuC+58], acc9           // copy acc to vreg[10]
v_accvgpr_read_b32 v[vgprValuC+59], acc13          // copy acc to vreg[11]
v_accvgpr_read_b32 v[vgprValuC+64], acc10          // copy acc to vreg[12]
v_accvgpr_read_b32 v[vgprValuC+65], acc14          // copy acc to vreg[13]
...
s_add_u32 s[sgprSrdD+0], s[sgprSrdD+0], s72        // incToNextRow: gra SRD += inc(lower)
s_addc_u32 s[sgprSrdD+1], s[sgprSrdD+1], 0         // incToNextRow: gra SRD += inc(upper)
buffer_store_dwordx4 v[56:59], v9, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D 2

buffer_store_dwordx4 v[64:67], v9, s[sgprSrdD:sgprSrdD+3], 0 offen offset:16, sc0 sc1 // store D 3
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
...
s_waitcnt vmcnt(6)                                 // (wait for buffer ready)
v_pk_add_f32 v[56:57], v[56:57], v[92:93]          // buffer pk
v_pk_add_f32 v[58:59], v[58:59], v[94:95]          // buffer pk
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 3
s_cmp_le_i32 s[sgprGSUSync], -6
s_cbranch_scc1 label_Synchronizer_read_add_skip_18 // SyncAddbranch
s_add_u32 s80, s80, s74
...
s_waitcnt vmcnt(6)                                 // (wait for buffer ready)
v_pk_add_f32 v[56:57], v[56:57], v[100:101]        // buffer pk
v_pk_add_f32 v[58:59], v[58:59], v[102:103]        // buffer pk
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 4
s_cmp_le_i32 s[sgprGSUSync], -6
s_cbranch_scc1 label_Synchronizer_read_add_skip_18 // SyncAddbranch
s_add_u32 s80, s80, s74
...
s_waitcnt vmcnt(6)                                 // (wait for buffer ready)
v_pk_add_f32 v[56:57], v[56:57], v[108:109]        // buffer pk
v_pk_add_f32 v[58:59], v[58:59], v[110:111]        // buffer pk
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 5
s_cmp_le_i32 s[sgprGSUSync], -6
s_cbranch_scc1 label_Synchronizer_read_add_skip_18 // SyncAddbranch
s_add_u32 s80, s80, s74
...
s_waitcnt vmcnt(6)                                 // (wait for buffer ready)
v_pk_add_f32 v[56:57], v[56:57], v[116:117]        // buffer pk
v_pk_add_f32 v[58:59], v[58:59], v[118:119]        // buffer pk
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 6
s_cmp_le_i32 s[sgprGSUSync], -6
s_cbranch_scc1 label_Synchronizer_read_add_skip_18 // SyncAddbranch
s_add_u32 s80, s80, s74
...
s_mov_b32 s82, s[sgprSrdD+2]
s_mov_b32 s83, s[sgprSrdD+3]
buffer_load_dwordx4 v[64:67], v9, s[80:83], 0 offen offset:16, sc0 sc1 // load GSU D 0
s_mov_b32 s[sgprGSUSync], s[sgprGSU]
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 0
s_add_u32 s80, s80, s74
s_addc_u32 s81, s81, s75
...
s_waitcnt vmcnt(6)                                 // (wait for buffer ready)
v_pk_add_f32 v[64:65], v[64:65], v[76:77]          // buffer pk
v_pk_add_f32 v[66:67], v[66:67], v[78:79]          // buffer pk
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_cmp_le_i32 s[sgprGSUSync], -6
s_cbranch_scc1 label_Synchronizer_read_add_skip_19 // SyncAddbranch
s_add_u32 s80, s80, s74
...
s_waitcnt vmcnt(6)                                 // (wait for buffer ready)
v_pk_add_f32 v[64:65], v[64:65], v[92:93]          // buffer pk
v_pk_add_f32 v[66:67], v[66:67], v[94:95]          // buffer pk
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 3
s_cmp_le_i32 s[sgprGSUSync], -6
s_cbranch_scc1 label_Synchronizer_read_add_skip_19 // SyncAddbranch
s_add_u32 s80, s80, s74
...
s_waitcnt vmcnt(6)                                 // (wait for buffer ready)
v_pk_add_f32 v[64:65], v[64:65], v[108:109]        // buffer pk
v_pk_add_f32 v[66:67], v[66:67], v[110:111]        // buffer pk
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 5
s_cmp_le_i32 s[sgprGSUSync], -6
s_cbranch_scc1 label_Synchronizer_read_add_skip_19 // SyncAddbranch
s_add_u32 s80, s80, s74
...
v_fmac_f32 v[vgprValuC+49], v33, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_fmac_f32 v[vgprValuC+50], v34, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_fmac_f32 v[vgprValuC+51], v35, s[sgprBeta]       // finalSum = sum*alpha + C*beta
...
v_fmac_f32 v[vgprValuC+56], v52, s[sgprBeta]       // finalSum = sum*alpha + C*beta
...
v_fmac_f32 v[vgprValuC+59], v55, s[sgprBeta]       // finalSum = sum*alpha + C*beta
...
v_cndmask_b32 v44, 1.0, v44, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_cndmask_b32 v45, 1.0, v45, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_pk_mul_f32 v[vgprValuC+64:vgprValuC+64+1], v[44:45], v[vgprValuC+64:vgprValuC+64+1] // *= scaleAlphaVecVMulPK(44)(0)
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v46, 1.0, v46, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_cndmask_b32 v47, 1.0, v47, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_pk_mul_f32 v[vgprValuC+66:vgprValuC+66+1], v[46:47], v[vgprValuC+66:vgprValuC+66+1] // *= scaleAlphaVecVMulPK(44)(2)
v_fmac_f32 v[vgprValuC+64], v60, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_fmac_f32 v[vgprValuC+65], v61, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_fmac_f32 v[vgprValuC+66], v62, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_fmac_f32 v[vgprValuC+67], v63, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_pk_add_f32 v[4:5], v[40:41], v[vgprValuC+64:vgprValuC+64+1] // C += bias
v_pk_add_f32 v[6:7], v[42:43], v[vgprValuC+66:vgprValuC+66+1] // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v64, v4
v_mov_b32 v65, v5
v_mov_b32 v66, v6
v_mov_b32 v67, v7
buffer_store_dwordx4 v[64:67], v10, s[sgprSrdTD:sgprSrdTD+3], 0 offen offset:16, sc0 sc1 // store TD not StoreRemapVectorWidth
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
...
ds_read_b32 v39, v35 offset:0                      // load bias
v_lshlrev_b32 v36, 0x2, v4                         // ScaleAlphaVec address scaled by BPE
buffer_load_dword v40, v36, s[sgprSrdScaleAlphaVec:sgprSrdScaleAlphaVec+3], 0 offen offset:0 // load scaleAlphaVecI
...
v_cndmask_b32 v42, v122, v42, s[76:77]             // LDC clip if OOB. offset
...
v_cndmask_b32 v44, v122, v44, s[76:77]             // LDBias clip if OOB. offset
...
v_cndmask_b32 v42, v122, v42, s[76:77]             // LDD clip if OOB. offset
v_add_lshl_u32 v43, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v43, v122, v43, s[76:77]             // LDTD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,5) */
v_add_co_u32 v4, vcc, v0, 5                        // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[72:73], v4, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[76:77], v1, s[sgprSizeJ]            // coord1 < size1
...
v_cndmask_b32 v50, v122, v50, s[76:77]             // LDC clip if OOB. offset
...
v_cndmask_b32 v50, v122, v50, s[76:77]             // LDD clip if OOB. offset
v_add_lshl_u32 v51, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v51, v122, v51, s[76:77]             // LDTD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,6) */
v_add_co_u32 v4, vcc, v0, 6                        // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[72:73], v4, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[76:77], v1, s[sgprSizeJ]            // coord1 < size1
...
buffer_store_dword v41, v33, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D 3
...
s_mov_b32 s86, s[sgprSrdD+2]
s_mov_b32 s87, s[sgprSrdD+3]
buffer_load_dword v41, v33, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU D 0
s_mov_b32 s[sgprGSUSync], s[sgprGSU]
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 0
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v123, v42, v122, s[80:81]            // 1. mul 1 if 0
buffer_load_dword v124, v123, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v123, v50, v122, s[80:81]            // 1. mul 1 if 0
buffer_load_dword v124, v123, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v41, v4
buffer_store_dword v41, v34, s[sgprSrdTD:sgprSrdTD+3], 0 offen offset:0, sc0 sc1 // store TD not StoreRemapVectorWidth
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v40, 1.0, v40, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+97], v40, v[vgprValuC+97]    // *= scaleAlphaVecVMul
v_fmac_f32 v[vgprValuC+97], v96, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_add_f32 v4, v39, v[vgprValuC+97]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v97, v4
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v48, 1.0, v48, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+103], v48, v[vgprValuC+103]  // *= scaleAlphaVecVMul
v_fmac_f32 v[vgprValuC+103], v102, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_add_f32 v4, v47, v[vgprValuC+103]                // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v103, v4
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v56, 1.0, v56, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+109], v56, v[vgprValuC+109]  // *= scaleAlphaVecVMul
v_fmac_f32 v[vgprValuC+109], v108, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_add_f32 v4, v55, v[vgprValuC+109]                // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v109, v4
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v64, 1.0, v64, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+115], v64, v[vgprValuC+115]  // *= scaleAlphaVecVMul
v_fmac_f32 v[vgprValuC+115], v114, s[sgprBeta]     // finalSum = sum*alpha + C*beta
v_add_f32 v4, v63, v[vgprValuC+115]                // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v115, v4
...
v_cndmask_b32 v41, v90, v41, s[76:77]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v40, v90, v40, s[76:77]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,6) */
v_add_co_u32 v4, vcc, v0, 6                        // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[72:73], v4, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[76:77], v1, s[sgprSizeJ]            // coord1 < size1
...
v_sub_u32 v47, v4, s72
v_lshlrev_b32 v47, 0x2, v47                        // Bias address scaled by BPE
v_cndmask_b32 v47, v90, v47, s[76:77]              // LDBias clip if OOB. offset
ds_read_b32 v49, v47 offset:0                      // load bias
v_lshlrev_b32 v48, 0x2, v4                         // ScaleAlphaVec address scaled by BPE
buffer_load_dword v50, v48, s[sgprSrdScaleAlphaVec:sgprSrdScaleAlphaVec+3], 0 offen offset:0 // load scaleAlphaVecI
v_add_lshl_u32 v46, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v46, v90, v46, s[76:77]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,7) */
v_add_co_u32 v4, vcc, v0, 7                        // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[72:73], v4, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[76:77], v1, s[sgprSizeJ]            // coord1 < size1
...
v_cndmask_b32 v53, v90, v53, s[76:77]              // LDBias clip if OOB. offset
...
v_add_lshl_u32 v52, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v52, v90, v52, s[76:77]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,0,0) */
v_add_co_u32 v1, vcc, v1, 64                       // coord1.1: coord1Vgpr += d1*sg1*VW + vc1
...
v_cndmask_b32 v59, v90, v59, s[76:77]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v58, v90, v58, s[76:77]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,0,1) */
v_add_co_u32 v4, vcc, v0, 1                        // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[72:73], v4, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[76:77], v1, s[sgprSizeJ]            // coord1 < size1
...
v_cndmask_b32 v63, v90, v63, s[76:77]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v62, v90, v62, s[76:77]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,0,2) */
v_add_co_u32 v4, vcc, v0, 2                        // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[72:73], v4, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[76:77], v1, s[sgprSizeJ]            // coord1 < size1
...
v_add_lshl_u32 v66, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v66, v90, v66, s[76:77]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,0,3) */
v_add_co_u32 v4, vcc, v0, 3                        // coord0.1: coord0 += d0*sg0*VW + vc0
v_cmp_lt_u32 s[72:73], v4, s[sgprSizeI]            // coord0 < size0
v_cmp_lt_u32 s[76:77], v1, s[sgprSizeJ]            // coord1 < size1
...
v_accvgpr_read_b32 v[vgprValuC+65], acc12          // copy acc to vreg[9]
...
v_mul_f32 v[vgprValuC+39], v37, v[vgprValuC+39]    // *= scaleAlphaVecVMul
v_add_f32 v4, v36, v[vgprValuC+39]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v39, v4
buffer_store_dword v39, v33, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D not StoreRemapVectorWidth
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v44, 1.0, v44, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v13, 1.0, v13, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+61], v13, v[vgprValuC+61]    // *= scaleAlphaVecVMul
v_add_f32 v4, v12, v[vgprValuC+61]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v61, v4
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v19, 1.0, v19, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+65], v19, v[vgprValuC+65]    // *= scaleAlphaVecVMul
v_add_f32 v4, v18, v[vgprValuC+65]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v65, v4
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v44, 1.0, v44, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+81], v44, v[vgprValuC+81]    // *= scaleAlphaVecVMul
v_add_f32 v4, v43, v[vgprValuC+81]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v81, v4
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v50, 1.0, v50, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+85], v50, v[vgprValuC+85]    // *= scaleAlphaVecVMul
v_add_f32 v4, v49, v[vgprValuC+85]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v85, v4
...
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v56, 1.0, v56, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+89], v56, v[vgprValuC+89]    // *= scaleAlphaVecVMul
v_add_f32 v4, v55, v[vgprValuC+89]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v89, v4
...
s_add_u32 s[sgprSrdC+0], s[sgprSrdC+0], s72        // incToNextRow: gra SRD += inc(lower)
s_addc_u32 s[sgprSrdC+1], s[sgprSrdC+1], 0         // incToNextRow: gra SRD += inc(upper)
buffer_load_dwordx4 v[52:55], v10, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
/* (d1,vc1,d0,vc0)=(1,0,0,4) */
buffer_load_dwordx4 v[60:63], v10, s[sgprSrdC:sgprSrdC+3], 0 offen offset:16 // load C
v_add_lshl_u32 v9, v3, v0, 0x2                     // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
v_accvgpr_read_b32 v[vgprValuC+28], acc0           // copy acc to vreg[0]
v_accvgpr_read_b32 v[vgprValuC+29], acc4           // copy acc to vreg[1]
v_accvgpr_read_b32 v[vgprValuC+30], acc1           // copy acc to vreg[2]
...
v_mov_b32 v66, v6
v_mov_b32 v67, v7
buffer_store_dwordx4 v[64:67], v9, s[sgprSrdD:sgprSrdD+3], 0 offen offset:16, sc0 sc1 // store D not StoreRemapVectorWidth
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
//synchronizer end
s_branch label_GW_End_2                            // jump to end
...
buffer_load_dword v41, v37, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
s_mul_i32 s72, 32, s[sgprWorkGroup0]               // wgp0 * MT0
...
v_cndmask_b32 v45, v106, v45, s[76:77]             // LDC clip if OOB. offset
...
v_cndmask_b32 v52, v106, v52, s[76:77]             // LDC clip if OOB. offset
...
v_cndmask_b32 v59, v106, v59, s[76:77]             // LDC clip if OOB. offset
...
v_cndmask_b32 v66, v106, v66, s[76:77]             // LDC clip if OOB. offset
...
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v44, v4
buffer_store_dword v44, v37, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D not StoreRemapVectorWidth
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v50, 1.0, v50, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+51], v50, v[vgprValuC+51]    // *= scaleAlphaVecVMul
...
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v70, v4
buffer_store_dword v70, v66, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D not StoreRemapVectorWidth
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v21, 1.0, v21, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+75], v21, v[vgprValuC+75]    // *= scaleAlphaVecVMul
