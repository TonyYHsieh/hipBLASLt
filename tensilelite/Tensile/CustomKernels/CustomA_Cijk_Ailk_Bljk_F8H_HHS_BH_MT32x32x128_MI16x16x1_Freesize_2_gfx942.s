...
s_mul_i32 s71, s71, 32                             // Each wave loads continuous lsp(16)*nrp(2) columns
...
v_add_co_u32 v10, vcc, 16, v9                      // groAL_1 + LSPA
...
s_cbranch_scc0 label_NoBranch_ABNUYKTZLG6WAPZK_0   // Only branch on scc1
...
label_NoBranch_ABNUYKTZLG6WAPZK_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[74:75], v[vgprG2LA+2+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+0], v74 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+0], v75 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[74:75], v[vgprG2LA+2+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+1], v74 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+1], v75 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[74:75], v[vgprG2LA+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+2], v74 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+2], v75 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[74:75], v[vgprG2LA+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+3], v74 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+3], v75 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+0:vgprG2LA+0+3] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
v_cvt_pk_f32_fp8 v[74:75], v[vgprG2LA+6+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+0], v74 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+0], v75 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[74:75], v[vgprG2LA+6+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+1], v74 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+1], v75 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[74:75], v[vgprG2LA+6+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+2], v74 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+2], v75 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[74:75], v[vgprG2LA+6+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+3], v74 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+3], v75 dst_sel:WORD_1  // Convert to FP16
...
/* endSummation: add vgpr [0...72) to pool */
/* load store sgprs */
/* load store sgprs2 */
...
/* Tail: add address/G2L vgpr [48...72) to pool */
...
/* Tail: remove address/G2L [48...72) from pool */
label_Summation_End_FCY9QG9185LQ391A_0:
/* endSummation: add vgpr [0...72) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_3PKBKR8IYOVSFXME_0   // Only branch on scc1
...
label_NoBranch_3PKBKR8IYOVSFXME_0:
