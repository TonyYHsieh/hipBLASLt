...
s_mov_b32 s71, 2048                                // LSU offset: stride = lsuStride(64)*(MT0(32) + PAD0(0))
...
s_cbranch_scc0 label_NoBranch_GJRLOCFJTY4SR730_0   // Only branch on scc1
...
label_NoBranch_GJRLOCFJTY4SR730_0:
...
s_cbranch_scc1 label_NoBranch_1HA1RSS3R6FNYIYW_0   // Only branch on scc0
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_1HA1RSS3R6FNYIYW_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_RQ93TTH31EXHBU50_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_RQ93TTH31EXHBU50_0:
...
s_cbranch_scc0 label_NoBranch_OG4Q30JNDQXA51A2_0   // Only branch on scc1
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_OG4Q30JNDQXA51A2_0:
...
s_cbranch_scc0 label_NoBranch_UUG92WKTO4A4QJGI_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_UUG92WKTO4A4QJGI_0:

s_and_b32 s73, 63, s[sgprSizesSum+0]               // s73 = s[sgprSizesSum+0] % 64
s_cmp_eq_u32 s73, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_660V0XO5CU74G9DU_0   // Only branch on scc0
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_660V0XO5CU74G9DU_0:
...
label_Summation_End_WAGCH5A9B2VWPX6X_0:
/* endSummation: add vgpr [0...40) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_UCPOQAGEOPIH6VL7_0   // Only branch on scc1
...
label_NoBranch_UCPOQAGEOPIH6VL7_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
...
v_cndmask_b32 v33, v42, v33, s[76:77]              // LDC clip if OOB. offset
...
v_cndmask_b32 v35, v42, v35, s[76:77]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v33, v42, v33, s[76:77]              // LDD clip if OOB. offset
v_add_lshl_u32 v34, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v34, v42, v34, s[76:77]              // LDTD clip if OOB. offset
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v43, v33, v42, s[80:81]              // 1. mul 1 if 0
buffer_load_dword v44, v43, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_mul_f32 v[vgprValuC+41], v39, v[vgprValuC+41]    // *= scaleAlphaVecVMul
v_fmac_f32 v[vgprValuC+41], v37, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_add_f32 v4, v38, v[vgprValuC+41]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v41, v4
