...
s_mov_b32 m0, 0x6600                               // LDS clamp at 26112 bytes
...
v_add_co_u32 v11, vcc, 8, v10                      // groAL_2 + LSPA
v_add_co_u32 v12, vcc, 8, v11                      // groAL_3 + LSPA
...
s_cbranch_scc0 label_NoBranch_7FTM0X6X564Y10U2_0   // Only branch on scc1
...
label_NoBranch_7FTM0X6X564Y10U2_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+2+0] src0_sel:WORD_0 // convert to F32
...
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+2+0] src0_sel:WORD_1 // convert to F32
...
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+2+1] src0_sel:WORD_0 // convert to F32
...
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+2+1] src0_sel:WORD_1 // convert to F32
...
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+6+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+0], v100 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+0], v101 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+6+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+1], v100 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+1], v101 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+6+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+2], v100 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+2], v101 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+6+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+3], v100 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+3], v101 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+4:vgprG2LA+4+3] offset:1056 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 1056
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+10+0] src0_sel:WORD_0 // convert to F32
...
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+10+0] src0_sel:WORD_1 // convert to F32
...
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+10+1] src0_sel:WORD_0 // convert to F32
...
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+10+1] src0_sel:WORD_1 // convert to F32
...
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+14+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+0], v100 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+0], v101 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+14+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+1], v100 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+1], v101 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+14+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+2], v100 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+2], v101 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[100:101], v[vgprG2LA+14+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+3], v100 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+3], v101 dst_sel:WORD_1 // Convert to FP16
...
/*  numMfmaForLR:1, syncPlrMfmaIndex:14  */
/*  mfmaIndex:12  */
s_waitcnt lgkmcnt(10)                              // wait for prior local read local write old=4, new=10 newLW=6 newLR=0
/* pack scheduling: packAIdx:2, packBIdx:0 */
...
label_Summation_End_O4SPI1OXLLEJ856W_0:
/* endSummation: add vgpr [0...98) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_6UCOAZAVZCJ7J5RD_0   // Only branch on scc1
...
label_NoBranch_6UCOAZAVZCJ7J5RD_0:
