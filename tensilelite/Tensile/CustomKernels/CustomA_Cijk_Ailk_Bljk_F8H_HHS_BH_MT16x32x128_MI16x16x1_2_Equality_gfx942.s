...
v_mov_b32 v14, s70                                 // edge vgpr = Size0I- WG*MT - margin(8)
...
s_lshl_b32 s71, s70, 1                             // shift by StaggerUStride
...
s_cbranch_scc0 label_NoBranch_PW9L9EDWMPAK4V95_0   // Only branch on scc1
...
label_NoBranch_PW9L9EDWMPAK4V95_0:
...
/* Tail: add address/G2L vgpr [32...66) to pool */
...
/* Tail: remove address/G2L [32...66) from pool */
label_Summation_End_YQJLFVMI9CHS3X88_0:
/* endSummation: add vgpr [0...66) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_UOLZI1N69ISWCTHJ_0   // Only branch on scc1
...
label_NoBranch_UOLZI1N69ISWCTHJ_0:
