...
s_cbranch_scc0 label_NoBranch_3MTCYPFXNOO8091M_0   // Only branch on scc1
...
label_NoBranch_3MTCYPFXNOO8091M_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[42:43], v[vgprG2LA+2+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+0], v42 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+0], v43 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[42:43], v[vgprG2LA+2+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+1], v42 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+1], v43 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[42:43], v[vgprG2LA+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+2], v42 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+2], v43 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[42:43], v[vgprG2LA+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+3], v42 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+3], v43 dst_sel:WORD_1  // Convert to FP16
...
label_Summation_End_2AT3XZ4KVKBC6CQ5_0:
/* endSummation: add vgpr [0...40) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_PDDNGPMWDYRGWMYU_0   // Only branch on scc1
...
label_NoBranch_PDDNGPMWDYRGWMYU_0:
