...
s_cbranch_scc0 label_NoBranch_3XGYCHVXF9Q6OEWX_0   // Only branch on scc1
...
label_NoBranch_3XGYCHVXF9Q6OEWX_0:
...
s_cbranch_scc1 label_NoBranch_BAICXYR7LOB5KSGP_0   // Only branch on scc0
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_BAICXYR7LOB5KSGP_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_V8N8OY47SLPQT5DK_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_V8N8OY47SLPQT5DK_0:
...
s_cbranch_scc0 label_NoBranch_7EEHG6P0ULRWAMT9_0   // Only branch on scc1
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_7EEHG6P0ULRWAMT9_0:
...
s_cbranch_scc0 label_NoBranch_628NJ773H9U87HDT_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_628NJ773H9U87HDT_0:

s_and_b32 s73, 127, s[sgprSizesSum+0]              // s73 = s[sgprSizesSum+0] % 128
s_cmp_eq_u32 s73, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_8QYNDGF5I78QLX2Z_0   // Only branch on scc0
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_8QYNDGF5I78QLX2Z_0:
...
label_Summation_End_WS94SO473YCK2WDJ_0:
/* endSummation: add vgpr [0...78) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_KPAOTXIE3T21TNNL_0   // Only branch on scc1
...
label_NoBranch_KPAOTXIE3T21TNNL_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
...
buffer_load_dwordx4 v[128:131], v9, s[80:83], 0 offen offset:0, sc0 sc1 // load GSU DD
...
buffer_load_dwordx4 v[136:139], v9, s[80:83], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
v_cmp_ge_i32 s[76:77], 0, s[sgprGSUSync]
v_cndmask_b32 v15, v9, v14, s[76:77]               // 1. mul 1 if 0
buffer_load_dwordx4 v[128:131], v15, s[80:83], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[76:77], 0, s[sgprGSUSync]
v_cndmask_b32 v15, v9, v14, s[76:77]               // 1. mul 1 if 0
buffer_load_dwordx4 v[136:139], v15, s[80:83], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
