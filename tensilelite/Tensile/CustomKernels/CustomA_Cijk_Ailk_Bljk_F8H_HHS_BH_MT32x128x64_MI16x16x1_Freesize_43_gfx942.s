...
s_cbranch_scc0 label_NoBranch_BGM08HD4XKDXD2XP_0   // Only branch on scc1
...
label_NoBranch_BGM08HD4XKDXD2XP_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[68:69], v[vgprG2LA+1+0] src0_sel:WORD_0 // convert to F32
...
v_cvt_pk_f32_fp8 v[68:69], v[vgprG2LA+1+0] src0_sel:WORD_1 // convert to F32
...
v_cvt_pk_f32_fp8 v[68:69], v[vgprG2LA+3+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+2+0], v68 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+2+0], v69 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[68:69], v[vgprG2LA+3+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+2+1], v68 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+2+1], v69 dst_sel:WORD_1  // Convert to FP16
...
label_Summation_End_D8PXJ0CXGXKSVOSZ_0:
/* endSummation: add vgpr [0...66) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_55GU5RIZJXCS17B1_0   // Only branch on scc1
...
label_NoBranch_55GU5RIZJXCS17B1_0:
