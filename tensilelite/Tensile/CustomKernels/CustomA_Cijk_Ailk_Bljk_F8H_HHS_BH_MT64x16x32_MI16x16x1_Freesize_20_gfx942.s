...
s_cbranch_scc0 label_NoBranch_A3XDRS7VH3D0A4D7_0   // Only branch on scc1
...
label_NoBranch_A3XDRS7VH3D0A4D7_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[24:25], v[vgprG2LA+2+0] src0_sel:WORD_0 // convert to F32
...
v_cvt_pk_f32_fp8 v[24:25], v[vgprG2LA+2+0] src0_sel:WORD_1 // convert to F32
...
v_cvt_pk_f32_fp8 v[24:25], v[vgprG2LA+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+2], v24 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+2], v25 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[24:25], v[vgprG2LA+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+3], v24 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+3], v25 dst_sel:WORD_1  // Convert to FP16
...
label_Summation_End_IQS6ZYW85TNNLDBK_0:
/* endSummation: add vgpr [0...23) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_JHD11CEL1873935O_0   // Only branch on scc1
...
label_NoBranch_JHD11CEL1873935O_0:
...
s_addc_u32 s65, s65, s59
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v24, v6, v22, s[60:61]               // 1. mul 1 if 0
...
s_addc_u32 s65, s65, s59
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v24, v10, v22, s[60:61]              // 1. mul 1 if 0
buffer_load_dword v28, v24, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s65, s65, s59
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v24, v14, v22, s[60:61]              // 1. mul 1 if 0
buffer_load_dword v28, v24, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s65, s65, s59
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v24, v18, v22, s[60:61]              // 1. mul 1 if 0
buffer_load_dword v28, v24, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
