...
s_mov_b32 m0, 0x4c00                               // LDS clamp at 19456 bytes
...
s_cbranch_scc0 label_NoBranch_MGR6T3KE8B5CYA2G_0   // Only branch on scc1
...
label_NoBranch_MGR6T3KE8B5CYA2G_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+2+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+0], v58 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+0], v59 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+2+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+1], v58 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+1], v59 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+2], v58 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+2], v59 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+3], v58 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+3], v59 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+0:vgprG2LA+0+3] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+6+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+0], v58 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+0], v59 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+6+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+1], v58 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+1], v59 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+6+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+2], v58 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+2], v59 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+6+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+3], v58 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+3], v59 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+4:vgprG2LA+4+3] offset:1024 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 1024
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+10+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+0], v58 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+0], v59 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+10+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+1], v58 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+1], v59 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+10+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+2], v58 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+2], v59 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+10+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+3], v58 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+3], v59 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+8:vgprG2LA+8+3] offset:2112 // lwoA_0_0_2_0 = (0*LSCA) + (2*LSPA)(*MT0I+PAD) = 2112
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+14+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+0], v58 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+0], v59 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+14+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+1], v58 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+1], v59 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+14+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+2], v58 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+2], v59 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[58:59], v[vgprG2LA+14+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+3], v58 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+3], v59 dst_sel:WORD_1 // Convert to FP16
...
/* Tail: add address/G2L vgpr [28...56) to pool */
...
/* Tail: remove address/G2L [28...56) from pool */
label_Summation_End_LG088M9Q4KS6QHCF_0:
/* endSummation: add vgpr [0...56) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_1RJCPMHOIHPWP8W4_0   // Only branch on scc1
...
label_NoBranch_1RJCPMHOIHPWP8W4_0:
...
buffer_load_dwordx4 v[156:159], v6, s[60:63], 0 offen offset:0, sc0 sc1 // load GSU DD
buffer_load_dwordx4 v[160:163], v6, s[60:63], 0 offen offset:16, sc0 sc1 // load GSU DD
...
buffer_load_dwordx4 v[168:171], v6, s[60:63], 0 offen offset:16, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_add_u32 s60, s60, s54
s_addc_u32 s61, s61, s55
s_cmp_eq_i32 s[sgprGSUSync], 0
s_cbranch_scc1 label_Synchronizer_read_add_end_15_17 // SyncAddbranchhere
buffer_load_dwordx4 v[172:175], v6, s[60:63], 0 offen offset:0, sc0 sc1 // load GSU DD
buffer_load_dwordx4 v[176:179], v6, s[60:63], 0 offen offset:16, sc0 sc1 // load GSU DD
// buffer load end
...
v_pk_add_f32 v[18:19], v[18:19], v[158:159]        // buffer pk
...
v_cmp_ge_i32 s[56:57], 0, s[sgprGSUSync]
v_cndmask_b32 v10, v6, v9, s[56:57]                // 1. mul 1 if 0
buffer_load_dwordx4 v[156:159], v10, s[60:63], 0 offen offset:0, sc0 sc1 // load GSU DD
buffer_load_dwordx4 v[160:163], v10, s[60:63], 0 offen offset:16, sc0 sc1 // load GSU DD
...
v_pk_add_f32 v[22:23], v[22:23], v[170:171]        // buffer pk
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 13
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_17 // SyncAddbranch
s_add_u32 s60, s60, s54
...
buffer_load_dwordx4 v[168:171], v10, s[60:63], 0 offen offset:16, sc0 sc1 // load GSU DD

s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_pk_add_f32 v[16:17], v[16:17], v[172:173]        // buffer pk
v_pk_add_f32 v[18:19], v[18:19], v[174:175]        // buffer pk
...
v_cmp_ge_i32 s[56:57], 0, s[sgprGSUSync]
v_cndmask_b32 v10, v6, v9, s[56:57]                // 1. mul 1 if 0
buffer_load_dwordx4 v[172:175], v10, s[60:63], 0 offen offset:0, sc0 sc1 // load GSU DD
buffer_load_dwordx4 v[176:179], v10, s[60:63], 0 offen offset:16, sc0 sc1 // load GSU DD
// buffer add end
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v156, v31, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v164, v31, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD

s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v8, v8, v172                             // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_9  // SyncAddbranch
s_add_u32 s64, s64, s58
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v172, v31, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
...
buffer_load_dword v172, v9, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v11, v11, v172                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_10 // SyncAddbranch
s_add_u32 s64, s64, s58
...
buffer_load_dword v172, v12, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v14, v14, v172                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_11 // SyncAddbranch
s_add_u32 s64, s64, s58
...
buffer_load_dword v172, v15, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v20, v20, v172                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_13 // SyncAddbranch
s_add_u32 s64, s64, s58
...
buffer_load_dword v172, v21, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v23, v23, v172                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_14 // SyncAddbranch
s_add_u32 s64, s64, s58
...
buffer_load_dword v172, v24, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v26, v26, v172                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_15 // SyncAddbranch
s_add_u32 s64, s64, s58
...
buffer_load_dword v172, v27, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
v_pk_add_f32 v[30:31], v[30:31], v[170:171]        // buffer pk
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 13
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_8  // SyncAddbranch
s_add_u32 s60, s60, s54
...
v_pk_add_f32 v[26:27], v[26:27], v[174:175]        // buffer pk
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v39, v6, v38, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v172, v39, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
...
buffer_load_dword v60, v34, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
s_cbranch_scc1 label_Synchronizer_read_add_end_2_7 // SyncAddbranchhere
buffer_load_dword v68, v34, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 2
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
