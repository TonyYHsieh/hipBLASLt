...
s_mul_i32 s71, s71, 32                             // Each wave loads continuous lsp(32)*nrp(1) columns
...
s_cbranch_scc0 label_NoBranch_UW6SXDUZDVYI25IN_0   // Only branch on scc1
...
label_NoBranch_UW6SXDUZDVYI25IN_0:
...
label_Summation_End_SOXZKD9QZ5IENAAM_0:
/* endSummation: add vgpr [0...78) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_VUCA2YQZU8MSB052_0   // Only branch on scc1
...
label_NoBranch_VUCA2YQZU8MSB052_0:
