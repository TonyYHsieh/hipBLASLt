...
s_cbranch_scc0 label_NoBranch_656VOKJHB8PY4J10_0   // Only branch on scc1
...
label_NoBranch_656VOKJHB8PY4J10_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[62:63], v[vgprG2LA+1+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+0], v62 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+0], v63 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[62:63], v[vgprG2LA+1+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+1], v62 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+1], v63 dst_sel:WORD_1  // Convert to FP16
...
label_Summation_End_2HLKL4X080TDHJCN_0:
/* endSummation: add vgpr [0...60) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_6WXO00MSHZXQEQ57_0   // Only branch on scc1
...
label_NoBranch_6WXO00MSHZXQEQ57_0:
