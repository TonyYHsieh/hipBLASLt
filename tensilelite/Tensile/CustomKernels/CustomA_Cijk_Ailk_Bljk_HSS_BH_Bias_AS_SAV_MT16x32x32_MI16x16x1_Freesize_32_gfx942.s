...
v_mov_b32 v8, 2                                    // Global Read Wave: add back to cloumn index
...
v_add_co_u32 v9, vcc, 8, v8                        // groAL_1 + LSPA
...
v_mov_b32 v11, s71                                 // edge vgpr = Size0I- WG*MT - margin(2)
...
s_cbranch_scc0 label_NoBranch_D60FGTI7UJWB23T9_0   // Only branch on scc1
...
label_NoBranch_D60FGTI7UJWB23T9_0:
...
s_cbranch_scc1 label_NoBranch_U3EF37HZG308DQPV_0   // Only branch on scc0
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_U3EF37HZG308DQPV_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_BI7OT9TNQ8BI5UE4_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_BI7OT9TNQ8BI5UE4_0:
...
s_cbranch_scc0 label_NoBranch_IQLIDDKHQIWW3ZT7_0   // Only branch on scc1
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_IQLIDDKHQIWW3ZT7_0:
...
s_cbranch_scc0 label_NoBranch_7ES69KKOIH5O3UQ4_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_7ES69KKOIH5O3UQ4_0:

s_and_b32 s73, 31, s[sgprSizesSum+0]               // s73 = s[sgprSizesSum+0] % 32
s_cmp_eq_u32 s73, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_MQ1KRXYOZ1CL09XM_0   // Only branch on scc0
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_MQ1KRXYOZ1CL09XM_0:
...
label_Summation_End_ER2AGK85EPMEF989_0:
/* endSummation: add vgpr [0...26) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_2V71351MJZSZUPDO_0   // Only branch on scc1
...
label_NoBranch_2V71351MJZSZUPDO_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
...
v_mul_f32 v[vgprValuC+27], v25, v[vgprValuC+27]    // *= scaleAlphaVecVMul
v_add_f32 v4, v24, v[vgprValuC+27]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v27, v4
