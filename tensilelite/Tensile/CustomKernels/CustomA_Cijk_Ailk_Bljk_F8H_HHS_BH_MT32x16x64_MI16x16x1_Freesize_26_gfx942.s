...
s_cbranch_scc0 label_NoBranch_551W74DBDQUJBJWU_0   // Only branch on scc1
...
label_NoBranch_551W74DBDQUJBJWU_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[46:47], v[vgprG2LA+2+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+0], v46 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+0], v47 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[46:47], v[vgprG2LA+2+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+1], v46 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+1], v47 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[46:47], v[vgprG2LA+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+2], v46 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+2], v47 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[46:47], v[vgprG2LA+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+3], v46 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+3], v47 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+0:vgprG2LA+0+3] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
v_cvt_pk_f32_fp8 v[46:47], v[vgprG2LA+6+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+0], v46 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+0], v47 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[46:47], v[vgprG2LA+6+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+1], v46 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+1], v47 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[46:47], v[vgprG2LA+6+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+2], v46 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+2], v47 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[46:47], v[vgprG2LA+6+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+3], v46 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+3], v47 dst_sel:WORD_1  // Convert to FP16
...
/* Tail: add address/G2L vgpr [24...44) to pool */
...
/* Tail: remove address/G2L [24...44) from pool */
label_Summation_End_EJ356HZ527P7ZSHC_0:
/* endSummation: add vgpr [0...44) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_HDR1XTALOOJHXX8I_0   // Only branch on scc1
...
label_NoBranch_HDR1XTALOOJHXX8I_0:
