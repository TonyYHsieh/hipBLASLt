...
s_cbranch_scc0 label_NoBranch_R90YT0SEGMZAMRGA_0   // Only branch on scc1
...
label_NoBranch_R90YT0SEGMZAMRGA_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[28:29], v[vgprG2LA+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0], v28 dst_sel:WORD_0    // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0], v29 dst_sel:WORD_1    // Convert to FP16
ds_write_b32 v[vgprLocalWriteAddrA], v[vgprG2LA+0] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
v_cvt_pk_f32_fp8 v[28:29], v[vgprG2LA+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+1], v28 dst_sel:WORD_0    // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+1], v29 dst_sel:WORD_1    // Convert to FP16
...
label_Summation_End_THUS0SXH5NGY48VN_0:
/* endSummation: add vgpr [0...26) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_MK1CACTEUSF4WP86_0   // Only branch on scc1
...
label_NoBranch_MK1CACTEUSF4WP86_0:
