...
s_cbranch_scc0 label_NoBranch_9V7X9G87TBEDTNMM_0   // Only branch on scc1
...
label_NoBranch_9V7X9G87TBEDTNMM_0:
...
s_cbranch_scc1 label_NoBranch_P61AZCXYQMNNMFC2_0   // Only branch on scc0
s_getpc_b64 s[74:75]                               // addr of next instr
s_add_i32 s76, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s74, s74, s76                            // add target branch offset
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_P61AZCXYQMNNMFC2_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_MVGLDESGCNBIOCMO_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[74:75]                               // addr of next instr
s_add_i32 s76, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s74, s74, s76                            // add target branch offset
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_MVGLDESGCNBIOCMO_0:
...
s_cbranch_scc0 label_NoBranch_QN2TB0XLFM4LCAAF_0   // Only branch on scc1
...
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_QN2TB0XLFM4LCAAF_0:
...
s_cbranch_scc0 label_NoBranch_O6M8NRDJ7UXE0B4L_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[74:75]                               // addr of next instr
s_add_i32 s76, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s74, s74, s76                            // add target branch offset
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_O6M8NRDJ7UXE0B4L_0:

s_and_b32 s75, 31, s[sgprSizesSum+0]               // s75 = s[sgprSizesSum+0] % 32
s_cmp_eq_u32 s75, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_76ZR6GQS2SCNXBJC_0   // Only branch on scc0
...
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_76ZR6GQS2SCNXBJC_0:
...
label_Summation_End_6FYZCGHCQSXR1SRR_0:
/* endSummation: add vgpr [0...33) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_46KWPE0OKM4058C9_0   // Only branch on scc1
...
label_NoBranch_46KWPE0OKM4058C9_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
...
buffer_load_dword v34, v30, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
s_mul_i32 s72, 128, s[sgprWorkGroup0]              // wgp0 * MT0
