...
s_mov_b32 s51, 64                                  // LSU offset: stride = MT1(64) + PAD1(0)
...
s_cbranch_scc0 label_NoBranch_4CWWRWDVBG3DZHJW_0   // Only branch on scc1
...
label_NoBranch_4CWWRWDVBG3DZHJW_0:
...
/* local write b */
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+2+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+0+0], v60 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+0+0], v61 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+2+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+0+1], v60 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+0+1], v61 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+0+2], v60 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+0+2], v61 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+0+3], v60 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+0+3], v61 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrB], v[vgprG2LB+0:vgprG2LB+0+3] offset:0 // lwoB_0_0_0_0 = (0*LSCB)*(MT1J+PAD) + (0*LSPB) = 0
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+6+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+4+0], v60 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+4+0], v61 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+6+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+4+1], v60 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+4+1], v61 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+6+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+4+2], v60 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+4+2], v61 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+6+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+4+3], v60 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+4+3], v61 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrB], v[vgprG2LB+4:vgprG2LB+4+3] offset:1152 // lwoB_0_0_1_0 = (0*LSCB)*(MT1J+PAD) + (1*LSPB) = 1152
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+10+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+8+0], v60 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+8+0], v61 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+10+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+8+1], v60 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+8+1], v61 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+10+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+8+2], v60 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+8+2], v61 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+10+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+8+3], v60 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+8+3], v61 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrB], v[vgprG2LB+8:vgprG2LB+8+3] offset:2304 // lwoB_0_0_2_0 = (0*LSCB)*(MT1J+PAD) + (2*LSPB) = 2304
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+14+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+12+0], v60 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+12+0], v61 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+14+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+12+1], v60 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+12+1], v61 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+14+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+12+2], v60 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+12+2], v61 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[60:61], v[vgprG2LB+14+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+12+3], v60 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+12+3], v61 dst_sel:WORD_1 // Convert to FP16
...
v_xor_b32 v[vgprLocalWriteAddrB+0], 0x8000, v[vgprLocalWriteAddrB+0] // swap Red Blk
s_waitcnt lgkmcnt(14)                              // wait for prior local read local write old=0, new=14 newLW=12 newLR=2
...
s_mul_i32 s51, 64, s[sgprWorkGroup1]               // wgp1 * MT1
...
/* N/A */
v_lshrrev_b32 v0, 8, v[vgprSerial]                 // LSU offset: sgid = Serial / subGroup(256)
s_mov_b32 s5, 64                                   // LSU offset: stride = MT1(64) + PAD1(0)
...
/* Tail: add address/G2L vgpr [32...58) to pool */
...
v_cmp_ge_i32 s[74:75], v32, s[sgprLoopCounterL]    // check K index >= Size L
...
/* Tail: remove address/G2L [32...58) from pool */
label_Summation_End_JAW9H80HPSNNGQEQ_0:
/* endSummation: add vgpr [0...58) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_DBZLYTY489V3UZKO_0   // Only branch on scc1
...
label_NoBranch_DBZLYTY489V3UZKO_0:
