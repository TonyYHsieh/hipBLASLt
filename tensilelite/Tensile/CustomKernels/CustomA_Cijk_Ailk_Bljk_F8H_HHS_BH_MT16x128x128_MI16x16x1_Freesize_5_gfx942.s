...
v_readfirstlane_b32 s71, v[vgprSerial]             // WaveIdxWavefrontWidth
s_lshr_b32 s71, s71, 0x6                           // WaveId
s_mul_i32 s71, s71, 32                             // Each wave loads continuous lsp(4)*nrp(8) columns
...
v_mov_b32 v17, s71                                 // edge vgpr = Size0I- WG*MT - margin(8)
...
s_cbranch_scc0 label_NoBranch_JBUQOCYT27D6E9PG_0   // Only branch on scc1
...
label_NoBranch_JBUQOCYT27D6E9PG_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[116:117], v[vgprG2LA+2+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+0], v116 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+0], v117 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[116:117], v[vgprG2LA+2+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+1], v116 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+1], v117 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[116:117], v[vgprG2LA+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+2], v116 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+2], v117 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[116:117], v[vgprG2LA+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+3], v116 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+3], v117 dst_sel:WORD_1 // Convert to FP16
...
/* Tail: add address/G2L vgpr [64...114) to pool */
...
/* Tail: remove address/G2L [64...114) from pool */
label_Summation_End_SSJJ3VAHQK6Y89ZY_0:
/* endSummation: add vgpr [0...114) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_W3NAJ27LWIBHIAJX_0   // Only branch on scc1
...
label_NoBranch_W3NAJ27LWIBHIAJX_0:
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v39, v6, v38, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v44, v39, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
buffer_load_dword v44, v34, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 2
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
