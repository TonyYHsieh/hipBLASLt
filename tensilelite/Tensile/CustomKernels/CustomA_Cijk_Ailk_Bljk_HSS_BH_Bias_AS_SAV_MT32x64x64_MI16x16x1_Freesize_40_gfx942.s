...
s_mov_b32 m0, 0x7a00                               // LDS clamp at 31232 bytes
...
v_add_co_u32 v10, vcc, 8, v9                       // groAL_1 + LSPA
...
v_mov_b32 v12, s73                                 // edge vgpr = Size0I- WG*MT - margin(4)
...
s_cbranch_scc0 label_NoBranch_H5WK3232JVH0S4Z3_0   // Only branch on scc1
...
label_NoBranch_H5WK3232JVH0S4Z3_0:
...
s_cbranch_scc1 label_NoBranch_40X387D592V62HL9_0   // Only branch on scc0
s_getpc_b64 s[74:75]                               // addr of next instr
s_add_i32 s76, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s74, s74, s76                            // add target branch offset
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_40X387D592V62HL9_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_Z0ST9O9MEXCV8V68_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[74:75]                               // addr of next instr
s_add_i32 s76, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s74, s74, s76                            // add target branch offset
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_Z0ST9O9MEXCV8V68_0:
...
s_cbranch_scc0 label_NoBranch_UUO877JYDUIKXZQF_0   // Only branch on scc1
...
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_UUO877JYDUIKXZQF_0:
...
s_cbranch_scc0 label_NoBranch_NMQDN2C4QM9E4THH_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[74:75]                               // addr of next instr
s_add_i32 s76, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s74, s74, s76                            // add target branch offset
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_NMQDN2C4QM9E4THH_0:

s_and_b32 s75, 63, s[sgprSizesSum+0]               // s75 = s[sgprSizesSum+0] % 64
s_cmp_eq_u32 s75, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_0CW6JTWLQ20FC5R6_0   // Only branch on scc0
...
s_addc_u32 s75, s75, 0                             // add high and carry
s_setpc_b64 s[74:75]                               // branch to label_OptNLL_End
label_NoBranch_0CW6JTWLQ20FC5R6_0:
...
/* Tail: add address/G2L vgpr [28...48) to pool */
...
/* Tail: remove address/G2L [28...48) from pool */
label_Summation_End_TKUWMP95U0H6DTIU_0:
/* endSummation: add vgpr [0...48) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_14DBC2VFAINMS20M_0   // Only branch on scc1
...
label_NoBranch_14DBC2VFAINMS20M_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
...
buffer_store_dword v51, v44, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D 5
...
s_mov_b32 s86, s[sgprSrdD+2]
s_mov_b32 s87, s[sgprSrdD+3]
buffer_load_dword v51, v44, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU D 0
s_mov_b32 s[sgprGSUSync], s[sgprGSU]
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 0
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
...
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v51, v4
buffer_store_dword v51, v45, s[sgprSrdTD:sgprSrdTD+3], 0 offen offset:0, sc0 sc1 // store TD not StoreRemapVectorWidth
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
...
buffer_store_dword v49, v41, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D 4
...
s_mov_b32 s86, s[sgprSrdD+2]
s_mov_b32 s87, s[sgprSrdD+3]
buffer_load_dword v49, v41, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU D 0
s_mov_b32 s[sgprGSUSync], s[sgprGSU]
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 0
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
...
v_mul_f32 v[vgprValuC+49], v47, v[vgprValuC+49]    // *= scaleAlphaVecVMul
v_fmac_f32 v[vgprValuC+49], v45, s[sgprBeta]       // finalSum = sum*alpha + C*beta
v_add_f32 v4, v46, v[vgprValuC+49]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v49, v4
buffer_store_dword v49, v42, s[sgprSrdTD:sgprSrdTD+3], 0 offen offset:0, sc0 sc1 // store TD not StoreRemapVectorWidth
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
...
ds_read_b32 v49, v45 offset:0                      // load bias
v_lshlrev_b32 v46, 0x2, v4                         // ScaleAlphaVec address scaled by BPE
buffer_load_dword v50, v46, s[sgprSrdScaleAlphaVec:sgprSrdScaleAlphaVec+3], 0 offen offset:0 // load scaleAlphaVecI
v_add_lshl_u32 v44, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v44, v66, v44, s[76:77]              // LDD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(0,0,0,6) */
v_add_co_u32 v4, vcc, v0, 6                        // coord0.1: coord0 += d0*sg0*VW + vc0
...
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v51, v4
buffer_store_dword v51, v44, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0, sc0 sc1 // store D not StoreRemapVectorWidth
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
v_cmp_gt_u32 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], s[sgprSrdScaleAlphaVec+2], 0 //  == 0 ?
v_cndmask_b32 v57, 1.0, v57, s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1] // 1. mul 1 if 0
v_mul_f32 v[vgprValuC+58], v57, v[vgprValuC+58]    // *= scaleAlphaVecVMul
