...
s_mov_b32 m0, 0x6e00                               // LDS clamp at 28160 bytes
...
v_mov_b32 v12, s73                                 // edge vgpr = Size0I- WG*MT - margin(2)
...
buffer_load_short_d16_hi v[vgprG2LA+1], v[vgprGlobalReadOffsetA+1], s[sgprSrdA:sgprSrdA+3], 0 offen offset:0 // G -> Reg 0_0_1_0
...
s_cbranch_scc0 label_NoBranch_EZQ8855CW0FVSK5X_0   // Only branch on scc1
...
label_NoBranch_EZQ8855CW0FVSK5X_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[40:41], v[vgprG2LA+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0], v40 dst_sel:WORD_0    // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0], v41 dst_sel:WORD_1    // Convert to FP16
ds_write_b32 v[vgprLocalWriteAddrA], v[vgprG2LA+0] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
v_cvt_pk_f32_fp8 v[40:41], v[vgprG2LA+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+1], v40 dst_sel:WORD_0    // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+1], v41 dst_sel:WORD_1    // Convert to FP16
...
buffer_load_ubyte_d16 v[vgprG2LA+1+0], v[vgprGlobalReadOffsetA+1], s[sgprSrdA:sgprSrdA+3], 0 offen offset:0 // load one buffer value
/* g2l=1, load component 1 */
buffer_load_ubyte_d16_hi v0, v[vgprGlobalReadOffsetA+1], s[sgprSrdA:sgprSrdA+3], 0 offen offset:1 // load one buffer value
s_waitcnt vmcnt(0)
v_lshrrev_b32 v0, 0x8, v0                          // shift right to lower 8 bits
v_or_b32 v[vgprG2LA+1+0], v[vgprG2LA+1+0], v0      // HasEccHalf: pack
v_lshlrev_b32 v[vgprG2LA+1+0], 0x10, v[vgprG2LA+1+0] // shift left to higher 16 bits
...
ds_write_b32 v[vgprLocalWriteAddrA], v[vgprG2LA+0] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
v_cvt_pk_f32_fp8 v[0:1], v[vgprG2LA+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+1], v0 dst_sel:WORD_0     // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+1], v1 dst_sel:WORD_1     // Convert to FP16
ds_write_b32 v[vgprLocalWriteAddrA], v[vgprG2LA+1] offset:320 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 320
...
label_Summation_End_QDH1YD69DN5BNCXY_0:
/* endSummation: add vgpr [0...38) to pool */
.set sgprWGM, UNDEF
...
v_accvgpr_read_b32 v7, acc12                       // glvw 1 mb 0 tt1 1 r 0
s_nop 1                                            // v_accvgpr read vgpr after write vgpr: 2 wait states
...
v_accvgpr_read_b32 v7, acc14                       // glvw 1 mb 0 tt1 1 r 0
s_nop 1                                            // v_accvgpr read vgpr after write vgpr: 2 wait states
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_5ULRQR6Z79SIIS6Q_0   // Only branch on scc1
...
label_NoBranch_5ULRQR6Z79SIIS6Q_0:
