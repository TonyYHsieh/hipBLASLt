...
s_mov_b32 s71, 8192                                // LSU offset: stride = lsuStride(256)*(MT0(32) + PAD0(0))
...
s_mov_b32 s71, 256                                 // LSU offset: stride = lsuStride(256) when umlds==True
...
s_mul_i32 s71, s71, 128                            // Each wave loads continuous lsp(16)*nrp(8) columns
...
v_readfirstlane_b32 s71, v[vgprSerial]             // WaveIdxWavefrontWidth
s_lshr_b32 s71, s71, 0x6                           // WaveId
s_mul_i32 s71, s71, 8                              // Each wave loads continuous lsp(2)*nrp(4) columns
...
v_add_co_u32 v[vgprLocalWriteAddrB], vcc, 0x4400, v[vgprLocalWriteAddrB] // lwFOB = lwB1J + lwBL*MT1J + LDS_OFFSET_B=8704*2
...
v_add_co_u32 v12, vcc, 16, v11                     // groAL_1 + LSPA
v_add_co_u32 v13, vcc, 16, v12                     // groAL_2 + LSPA
v_add_co_u32 v14, vcc, 16, v13                     // groAL_3 + LSPA
v_add_co_u32 v15, vcc, 16, v14                     // groAL_4 + LSPA
v_add_co_u32 v16, vcc, 16, v15                     // groAL_5 + LSPA
v_add_co_u32 v17, vcc, 16, v16                     // groAL_6 + LSPA
v_add_co_u32 v18, vcc, 16, v17                     // groAL_7 + LSPA
...
v_mov_b32 v20, s71                                 // edge vgpr = Size0I- WG*MT - margin(8)
v_min_i32 v6, v20, v6                              // offset = (offset < edge) ? offset(v6) : edge(v20)

/* global read addresses: final offsets a */
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+0,  6, 11, 20 // gROA_0_0_0_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+1,  6, 12, 20 // gROA_0_0_1_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+2,  6, 13, 20 // gROA_0_0_2_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+3,  6, 14, 20 // gROA_0_0_3_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+4,  6, 15, 20 // gROA_0_0_4_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+5,  6, 16, 20 // gROA_0_0_5_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+6,  6, 17, 20 // gROA_0_0_6_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+7,  6, 18, 20 // gROA_0_0_7_0

/* global read addresses: final offsets b */
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+0, 19,  7, 11 // gROB_0_0_0_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+1, 19,  8, 11 // gROB_0_0_1_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+2, 19,  9, 11 // gROB_0_0_2_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+3, 19, 10, 11 // gROB_0_0_3_0

/* global read addresses: addresses a */
/* max read offset = size[n] * stride[n-1] */
s_mul_hi_u32 s75, s[sgprWorkGroup0], 32            // WorkGroup[01] * MT
s_mul_i32 s74, s[sgprWorkGroup0], 32               // WorkGroup[01] * MT
s_mul_hi_u32 s73, 256, s[sgprGSUSumIdx]            // gsuOffset = DepthU*bpeGR*GSUSumIdx
s_mul_i32 s72, 256, s[sgprGSUSumIdx]               // gsuOffset = DepthU*bpeGR*GSUSumIdx
...
s_cbranch_scc0 label_NoBranch_U4CF4VTC07MOKR7C_0   // Only branch on scc1
...
label_NoBranch_U4CF4VTC07MOKR7C_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+2+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+0], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+0], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+2+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+1], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+1], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+2], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+2], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+3], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+3], v163 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+0:vgprG2LA+0+3] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+6+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+0], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+0], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+6+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+1], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+1], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+6+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+2], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+2], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+6+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+3], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+3], v163 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+4:vgprG2LA+4+3] offset:1088 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 1088
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+10+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+0], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+0], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+10+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+1], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+1], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+10+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+2], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+2], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+10+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+3], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+3], v163 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+8:vgprG2LA+8+3] offset:2176 // lwoA_0_0_2_0 = (0*LSCA) + (2*LSPA)(*MT0I+PAD) = 2176
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+14+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+0], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+0], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+14+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+1], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+1], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+14+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+2], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+2], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+14+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+3], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+3], v163 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+12:vgprG2LA+12+3] offset:3264 // lwoA_0_0_3_0 = (0*LSCA) + (3*LSPA)(*MT0I+PAD) = 3264
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+18+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+16+0], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+16+0], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+18+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+16+1], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+16+1], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+18+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+16+2], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+16+2], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+18+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+16+3], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+16+3], v163 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+16:vgprG2LA+16+3] offset:4352 // lwoA_0_0_4_0 = (0*LSCA) + (4*LSPA)(*MT0I+PAD) = 4352
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+22+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+20+0], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+20+0], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+22+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+20+1], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+20+1], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+22+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+20+2], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+20+2], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+22+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+20+3], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+20+3], v163 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+20:vgprG2LA+20+3] offset:5440 // lwoA_0_0_5_0 = (0*LSCA) + (5*LSPA)(*MT0I+PAD) = 5440
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+26+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+24+0], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+24+0], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+26+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+24+1], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+24+1], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+26+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+24+2], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+24+2], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+26+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+24+3], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+24+3], v163 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+24:vgprG2LA+24+3] offset:6528 // lwoA_0_0_6_0 = (0*LSCA) + (6*LSPA)(*MT0I+PAD) = 6528
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+30+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+28+0], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+28+0], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+30+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+28+1], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+28+1], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+30+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+28+2], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+28+2], v163 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[162:163], v[vgprG2LA+30+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+28+3], v162 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+28+3], v163 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+28:vgprG2LA+28+3] offset:7616 // lwoA_0_0_7_0 = (0*LSCA) + (7*LSPA)(*MT0I+PAD) = 7616
...
/*  numMfmaForLR:0, syncPlrMfmaIndex:15  */
/*  mfmaIndex:7  */
ds_read_u16 v[vgprValuA_X8_I0+0], v[vgprLocalReadAddrA] offset:8704 // L -> Reg lro=4096 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=8 iui=0
ds_read_u16_d16_hi v[vgprValuA_X8_I0_D1+0], v[vgprLocalReadAddrA] offset:8768 // L -> Reg lro=4096 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=8 iui=0
ds_read_u16 v[vgprValuA_X8_I0+1], v[vgprLocalReadAddrA] offset:8832 // L -> Reg lro=4096 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=8 iui=0
ds_read_u16_d16_hi v[vgprValuA_X8_I0_D1+1], v[vgprLocalReadAddrA] offset:8896 // L -> Reg lro=4096 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=8 iui=0
s_add_u32 s[sgprSrdB+0], s[sgprSrdB+0], s72        // gra SRD += inc(lower)
...
/*  numMfmaForLR:0, syncPlrMfmaIndex:15  */
/*  mfmaIndex:8  */
ds_read_u16 v[vgprValuA_X9_I0+0], v[vgprLocalReadAddrA] offset:8960 // L -> Reg lro=4224 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=9 iui=0
ds_read_u16_d16_hi v[vgprValuA_X9_I0_D1+0], v[vgprLocalReadAddrA] offset:9024 // L -> Reg lro=4224 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=9 iui=0
ds_read_u16 v[vgprValuA_X9_I0+1], v[vgprLocalReadAddrA] offset:9088 // L -> Reg lro=4224 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=9 iui=0
ds_read_u16_d16_hi v[vgprValuA_X9_I0_D1+1], v[vgprLocalReadAddrA] offset:9152 // L -> Reg lro=4224 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=9 iui=0
s_addc_u32 s[sgprSrdB+1], s[sgprSrdB+1], s73       // gra SRD += inc(upper)
s_waitcnt lgkmcnt(4)                               // wait for prior local read local write old=0, new=4 newLW=0 newLR=4
/* pack scheduling: packAIdx:2, packBIdx:0 */
...
/*  numMfmaForLR:0, syncPlrMfmaIndex:15  */
/*  mfmaIndex:9  */
ds_read_u16 v[vgprValuA_X10_I0+0], v[vgprLocalReadAddrA] offset:10880 // L -> Reg lro=5120 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=10 iui=0
ds_read_u16_d16_hi v[vgprValuA_X10_I0_D1+0], v[vgprLocalReadAddrA] offset:10944 // L -> Reg lro=5120 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=10 iui=0
ds_read_u16 v[vgprValuA_X10_I0+1], v[vgprLocalReadAddrA] offset:11008 // L -> Reg lro=5120 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=10 iui=0
ds_read_u16_d16_hi v[vgprValuA_X10_I0_D1+1], v[vgprLocalReadAddrA] offset:11072 // L -> Reg lro=5120 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=10 iui=0
s_sub_u32 s[sgprShadowLimitB+0], s[sgprShadowLimitB+0], s72 // limit -= inc)
s_waitcnt lgkmcnt(4)                               // wait for prior local read local write old=0, new=4 newLW=0 newLR=4
/* pack scheduling: packAIdx:2, packBIdx:0 */
...
/*  numMfmaForLR:0, syncPlrMfmaIndex:15  */
/*  mfmaIndex:10  */
ds_read_u16 v[vgprValuA_X11_I0+0], v[vgprLocalReadAddrA] offset:11136 // L -> Reg lro=5248 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=11 iui=0
ds_read_u16_d16_hi v[vgprValuA_X11_I0_D1+0], v[vgprLocalReadAddrA] offset:11200 // L -> Reg lro=5248 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=11 iui=0
ds_read_u16 v[vgprValuA_X11_I0+1], v[vgprLocalReadAddrA] offset:11264 // L -> Reg lro=5248 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=11 iui=0
ds_read_u16_d16_hi v[vgprValuA_X11_I0_D1+1], v[vgprLocalReadAddrA] offset:11328 // L -> Reg lro=5248 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=11 iui=0
s_subb_u32 s[sgprShadowLimitB+1], s[sgprShadowLimitB+1], s73 // limit -= inc)
s_waitcnt lgkmcnt(4)                               // wait for prior local read local write old=0, new=4 newLW=0 newLR=4
/* pack scheduling: packAIdx:2, packBIdx:0 */
...
/*  numMfmaForLR:0, syncPlrMfmaIndex:15  */
/*  mfmaIndex:11  */
ds_read_u16 v[vgprValuA_X12_I0+0], v[vgprLocalReadAddrA] offset:13056 // L -> Reg lro=6144 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=12 iui=0
ds_read_u16_d16_hi v[vgprValuA_X12_I0_D1+0], v[vgprLocalReadAddrA] offset:13120 // L -> Reg lro=6144 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=12 iui=0
ds_read_u16 v[vgprValuA_X12_I0+1], v[vgprLocalReadAddrA] offset:13184 // L -> Reg lro=6144 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=12 iui=0
ds_read_u16_d16_hi v[vgprValuA_X12_I0_D1+1], v[vgprLocalReadAddrA] offset:13248 // L -> Reg lro=6144 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=12 iui=0
s_cmp_eq_u32 s[sgprShadowLimitB+1], 0              // are we within 2^32?
s_waitcnt lgkmcnt(4)                               // wait for prior local read local write old=0, new=4 newLW=0 newLR=4
/* pack scheduling: packAIdx:2, packBIdx:0 */
...
/*  numMfmaForLR:0, syncPlrMfmaIndex:15  */
/*  mfmaIndex:12  */
ds_read_u16 v[vgprValuA_X13_I0+0], v[vgprLocalReadAddrA] offset:13312 // L -> Reg lro=6272 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=13 iui=0
ds_read_u16_d16_hi v[vgprValuA_X13_I0_D1+0], v[vgprLocalReadAddrA] offset:13376 // L -> Reg lro=6272 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=13 iui=0
ds_read_u16 v[vgprValuA_X13_I0+1], v[vgprLocalReadAddrA] offset:13440 // L -> Reg lro=6272 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=13 iui=0
ds_read_u16_d16_hi v[vgprValuA_X13_I0_D1+1], v[vgprLocalReadAddrA] offset:13504 // L -> Reg lro=6272 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=13 iui=0
s_cselect_b32 s[sgprSrdB+2], s[sgprShadowLimitB+0], BufferLimit // Move shadow to real if we are within 2^32
...
v_xor_b32 v[vgprLocalWriteAddrB+0], 0x8000, v[vgprLocalWriteAddrB+0] // swap Red Blk
s_waitcnt lgkmcnt(15)                              // wait for prior local read local write old=0, new=16 newLW=12 newLR=4
/* pack scheduling: packAIdx:2, packBIdx:0 */
...
/*  numMfmaForLR:0, syncPlrMfmaIndex:15  */
/*  mfmaIndex:13  */
ds_read_u16 v[vgprValuA_X14_I0+0], v[vgprLocalReadAddrA] offset:15232 // L -> Reg lro=7168 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=14 iui=0
ds_read_u16_d16_hi v[vgprValuA_X14_I0_D1+0], v[vgprLocalReadAddrA] offset:15296 // L -> Reg lro=7168 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=14 iui=0
ds_read_u16 v[vgprValuA_X14_I0+1], v[vgprLocalReadAddrA] offset:15360 // L -> Reg lro=7168 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=14 iui=0
ds_read_u16_d16_hi v[vgprValuA_X14_I0_D1+1], v[vgprLocalReadAddrA] offset:15424 // L -> Reg lro=7168 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=14 iui=0
s_waitcnt lgkmcnt(15)                              // wait for prior local read local write old=0, new=16 newLW=12 newLR=4
/* pack scheduling: packAIdx:2, packBIdx:0 */
...
/*  numMfmaForLR:0, syncPlrMfmaIndex:15  */
/*  mfmaIndex:14  */
ds_read_u16 v[vgprValuA_X15_I0+0], v[vgprLocalReadAddrA] offset:15488 // L -> Reg lro=7296 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=0 oIdx=0 buffer=15 iui=0
ds_read_u16_d16_hi v[vgprValuA_X15_I0_D1+0], v[vgprLocalReadAddrA] offset:15552 // L -> Reg lro=7296 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=1 oIdx=0 buffer=15 iui=0
ds_read_u16 v[vgprValuA_X15_I0+1], v[vgprLocalReadAddrA] offset:15616 // L -> Reg lro=7296 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=2 oIdx=0 buffer=15 iui=0
ds_read_u16_d16_hi v[vgprValuA_X15_I0_D1+1], v[vgprLocalReadAddrA] offset:15680 // L -> Reg lro=7296 swapByteOffset=0 ti=32 vIdx=0 eIdx=0 rIdx=3 oIdx=0 buffer=15 iui=0
...
s_and_b32 s73, 255, s[sgprSizesSum+0]              // s73 = s[sgprSizesSum+0] % 256
...
/* endSummation: add vgpr [0...160) to pool */
/* load store sgprs */
/* load store sgprs2 */
...
/* Tail: add address/G2L vgpr [96...160) to pool */
...
v_cmp_ge_i32 s[72:73], v96, s[sgprLoopCounterL]    // check K index >= Size L
...
v_sub_u32 v96, s[sgprLoopCounterL], v96            // get distance between size and k index
v_cmp_lt_i32 s[72:73], v96, 4                      // set partial 0 if distance less than input per thread
...
v_lshlrev_b64 v[98:99], s71, v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+0], v[vgprValuA_X0_I0+0+0+0+0], v98, s[72:73]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+1], v[vgprValuA_X0_I0+0+0+0+1], v99, s[72:73]
v_lshlrev_b64 v[98:99], s71, v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+0], v[vgprValuB_X0_I0+0+0+0+0], v98, s[72:73]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0+1], v99, s[72:73]
s_nop 1
v_mfma_f32_16x16x16_f16 acc[0:3], v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1], acc[0:3] // left value = acc[0+0:3+0]
...
/* Tail: remove address/G2L [96...160) from pool */
label_Summation_End_81YQJIRPHW38QHR8_0:
/* endSummation: add vgpr [0...160) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_GO6IQTWUN0I3RDVL_0   // Only branch on scc1
...
label_NoBranch_GO6IQTWUN0I3RDVL_0:
...
buffer_load_dwordx4 v[16:19], v6, s[60:63], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_add_u32 s60, s60, s54
s_addc_u32 s61, s61, s55
s_cmp_eq_i32 s[sgprGSUSync], 0
s_cbranch_scc1 label_Synchronizer_read_add_end_2_9 // SyncAddbranchhere
buffer_load_dwordx4 v[20:23], v6, s[60:63], 0 offen offset:0, sc0 sc1 // load GSU DD
...
buffer_load_dwordx4 v[16:19], v10, s[60:63], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[56:57], 0, s[sgprGSUSync]
v_cndmask_b32 v10, v6, v9, s[56:57]                // 1. mul 1 if 0
buffer_load_dwordx4 v[20:23], v10, s[60:63], 0 offen offset:0, sc0 sc1 // load GSU DD
...
buffer_load_dword v20, v6, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
s_cbranch_scc1 label_Synchronizer_read_add_end_2_5 // SyncAddbranchhere
buffer_load_dword v24, v6, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 2
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v20, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v24, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
buffer_load_dword v20, v9, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
s_cbranch_scc1 label_Synchronizer_read_add_end_2_6 // SyncAddbranchhere
buffer_load_dword v24, v9, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 2
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v20, v12, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
s_cbranch_scc1 label_Synchronizer_read_add_end_2_7 // SyncAddbranchhere
buffer_load_dword v24, v12, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 2
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v20, v15, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
s_cbranch_scc1 label_Synchronizer_read_add_end_2_8 // SyncAddbranchhere
buffer_load_dword v24, v15, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 2
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v24, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
buffer_load_dword v24, v10, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v24, v14, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v24, v18, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
