...
v_mov_b32 v17, s70                                 // edge vgpr = Size0I- WG*MT - margin(8)
...
s_cbranch_scc0 label_NoBranch_9YDG4P9YQE5FRJFB_0   // Only branch on scc1
...
label_NoBranch_9YDG4P9YQE5FRJFB_0:
...
/*  mfmaIndex:11  */
s_cselect_b32 s[sgprSrdB+2], s[sgprShadowLimitB+0], BufferLimit // Move shadow to real if we are within 2^32
/* sched write - iter 5 writesPerItem=8 */
...
label_Summation_End_4C27OX1BPS29OY2T_0:
/* endSummation: add vgpr [0...98) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_Q8LKAFP2GDJ8SE4N_0   // Only branch on scc1
...
label_NoBranch_Q8LKAFP2GDJ8SE4N_0:
