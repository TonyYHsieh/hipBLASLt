...
s_cbranch_scc0 label_NoBranch_2WC6354WZBRQPGPJ_0   // Only branch on scc1
...
label_NoBranch_2WC6354WZBRQPGPJ_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[30:31], v[vgprG2LA+1+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+0], v30 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+0], v31 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[30:31], v[vgprG2LA+1+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+1], v30 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+1], v31 dst_sel:WORD_1  // Convert to FP16
ds_write_b64 v[vgprLocalWriteAddrA], v[vgprG2LA+0:vgprG2LA+0+1] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
v_cvt_pk_f32_fp8 v[30:31], v[vgprG2LA+3+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+2+0], v30 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+2+0], v31 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[30:31], v[vgprG2LA+3+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+2+1], v30 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+2+1], v31 dst_sel:WORD_1  // Convert to FP16
...
label_Summation_End_AXCKDOIRRAA9IIHH_0:
/* endSummation: add vgpr [0...28) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_3S14LSMBQM8I1RVW_0   // Only branch on scc1
...
label_NoBranch_3S14LSMBQM8I1RVW_0:
