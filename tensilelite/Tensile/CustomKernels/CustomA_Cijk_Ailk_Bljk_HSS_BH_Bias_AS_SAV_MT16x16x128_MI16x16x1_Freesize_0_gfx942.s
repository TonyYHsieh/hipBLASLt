...
s_mov_b32 s71, 2048                                // LSU offset: stride = lsuStride(128)*(MT0(16) + PAD0(0))
...
v_mov_b32 v16, s71                                 // edge vgpr = Size0I- WG*MT - margin(8)
...
s_cbranch_scc0 label_NoBranch_GIWM9PDQO17QF2EG_0   // Only branch on scc1
...
label_NoBranch_GIWM9PDQO17QF2EG_0:
...
s_cbranch_scc1 label_NoBranch_2TRHX0NNB58VABI9_0   // Only branch on scc0
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_2TRHX0NNB58VABI9_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_EYL0WFTCP5N5JONS_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_EYL0WFTCP5N5JONS_0:
...
s_cbranch_scc0 label_NoBranch_G4G8QDB32H0TIIBY_0   // Only branch on scc1
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_G4G8QDB32H0TIIBY_0:
...
s_cbranch_scc0 label_NoBranch_5W6PEE10GMZSJJU9_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_5W6PEE10GMZSJJU9_0:

s_and_b32 s73, 127, s[sgprSizesSum+0]              // s73 = s[sgprSizesSum+0] % 128
s_cmp_eq_u32 s73, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_E11412I6GUOQFU3V_0   // Only branch on scc0
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_E11412I6GUOQFU3V_0:
...
v_lshrrev_b32 v2, 6, v[vgprSerial]                 // v2 = v[vgprSerial] / 64
v_lshrrev_b32 v2, 0, v2                            // LSU offset: Get LSU wave_id
s_mov_b32 s5, 2048                                 // LSU offset: stride = lsuStride(128)*(MT0(16) + PAD0(0))
...
label_Summation_End_WPKSJR6JW9FRSGT9_0:
/* endSummation: add vgpr [0...92) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_QTT48COTWOHPDG8L_0   // Only branch on scc1
...
label_NoBranch_QTT48COTWOHPDG8L_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
...
buffer_load_dword v144, v9, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 13
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v152, v9, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v38, v9, v37, s[80:81]               // 1. mul 1 if 0
buffer_load_dword v120, v38, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v15, v15, v128                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 8
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_5  // SyncAddbranch
s_add_u32 s84, s84, s78
...
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v38, v9, v37, s[80:81]               // 1. mul 1 if 0
buffer_load_dword v128, v38, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v15, v15, v136                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 10
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_5  // SyncAddbranch
s_add_u32 s84, s84, s78
...
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v38, v9, v37, s[80:81]               // 1. mul 1 if 0
buffer_load_dword v136, v38, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v15, v15, v144                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 12
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_5  // SyncAddbranch
s_add_u32 s84, s84, s78
...
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v38, v9, v37, s[80:81]               // 1. mul 1 if 0
buffer_load_dword v144, v38, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v15, v15, v152                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_5  // SyncAddbranch
s_add_u32 s84, s84, s78
...
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v38, v9, v37, s[80:81]               // 1. mul 1 if 0
buffer_load_dword v152, v38, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
...
buffer_load_dword v128, v16, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 9
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v136, v16, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 11
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v144, v16, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 13
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v152, v16, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v22, v22, v128                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 8
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_6  // SyncAddbranch
s_add_u32 s84, s84, s78
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v22, v22, v136                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 10
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_6  // SyncAddbranch
s_add_u32 s84, s84, s78
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v22, v22, v144                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 12
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_6  // SyncAddbranch
s_add_u32 s84, s84, s78
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v22, v22, v152                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_6  // SyncAddbranch
s_add_u32 s84, s84, s78
...
buffer_load_dword v128, v23, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 9
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v136, v23, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 11
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v144, v23, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 13
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v152, v23, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
buffer_load_dword v144, v30, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 13
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v152, v30, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v36, v36, v128                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 8
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_8  // SyncAddbranch
s_add_u32 s84, s84, s78
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v36, v36, v136                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 10
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_8  // SyncAddbranch
s_add_u32 s84, s84, s78
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v36, v36, v144                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 12
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_8  // SyncAddbranch
s_add_u32 s84, s84, s78
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v36, v36, v152                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_8  // SyncAddbranch
s_add_u32 s84, s84, s78
...
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v42, v9, v41, s[80:81]               // 1. mul 1 if 0
buffer_load_dword v128, v42, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v42, v9, v41, s[80:81]               // 1. mul 1 if 0
buffer_load_dword v136, v42, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v16, v16, v144                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 12
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip    // SyncAddbranch
s_add_u32 s84, s84, s78
...
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v42, v9, v41, s[80:81]               // 1. mul 1 if 0
buffer_load_dword v144, v42, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v16, v16, v152                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip    // SyncAddbranch
s_add_u32 s84, s84, s78
...
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v42, v9, v41, s[80:81]               // 1. mul 1 if 0
buffer_load_dword v152, v42, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
...
buffer_load_dword v144, v17, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 13
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v152, v17, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v24, v24, v144                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 12
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_1  // SyncAddbranch
s_add_u32 s84, s84, s78
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v24, v24, v152                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_1  // SyncAddbranch
s_add_u32 s84, s84, s78
...
buffer_load_dword v144, v25, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 13
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v152, v25, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v32, v32, v144                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 12
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_2  // SyncAddbranch
s_add_u32 s84, s84, s78
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v32, v32, v152                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_2  // SyncAddbranch
s_add_u32 s84, s84, s78
...
buffer_load_dword v144, v33, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 13
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
buffer_load_dword v152, v33, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer load end
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v40, v40, v144                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 12
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_3  // SyncAddbranch
s_add_u32 s84, s84, s78
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v40, v40, v152                           // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 14
s_cmp_le_i32 s[sgprGSUSync], -14
s_cbranch_scc1 label_Synchronizer_read_add_skip_3  // SyncAddbranch
s_add_u32 s84, s84, s78
