...
s_cbranch_scc0 label_NoBranch_A1A35PSPDV89H9EP_0   // Only branch on scc1
...
label_NoBranch_A1A35PSPDV89H9EP_0:
...
s_cbranch_scc1 label_NoBranch_EVY6LYUCJYLHMMZ7_0   // Only branch on scc0
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_EVY6LYUCJYLHMMZ7_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_XW6KH57MNW5T5BCY_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_XW6KH57MNW5T5BCY_0:
...
s_cbranch_scc0 label_NoBranch_JX5THD2HS2ZZLRYM_0   // Only branch on scc1
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_JX5THD2HS2ZZLRYM_0:
...
s_cbranch_scc0 label_NoBranch_7BTPGF298HDHG226_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_7BTPGF298HDHG226_0:

s_and_b32 s73, 63, s[sgprSizesSum+0]               // s73 = s[sgprSizesSum+0] % 64
s_cmp_eq_u32 s73, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_PPTIKE9KLZNEHSG9_0   // Only branch on scc0
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_PPTIKE9KLZNEHSG9_0:
...
label_Summation_End_5XZCWK077MVHLAP8_0:
/* endSummation: add vgpr [0...42) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_7CLVA4XRGB41FPCV_0   // Only branch on scc1
...
label_NoBranch_7CLVA4XRGB41FPCV_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v43, v9, v41, s[80:81]               // 1. mul 1 if 0
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v43, v17, v41, s[80:81]              // 1. mul 1 if 0
buffer_load_dword v44, v43, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v43, v25, v41, s[80:81]              // 1. mul 1 if 0
buffer_load_dword v44, v43, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v43, v33, v41, s[80:81]              // 1. mul 1 if 0
buffer_load_dword v44, v43, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
