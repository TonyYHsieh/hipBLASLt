...
v_mov_b32 v14, s72                                 // edge vgpr = Size0I- WG*MT - margin(16)
...
s_cbranch_scc0 label_NoBranch_R47I70QYS83PC95U_0   // Only branch on scc1
...
label_NoBranch_R47I70QYS83PC95U_0:
...
/*  numMfmaForLR:1, syncPlrMfmaIndex:14  */
/*  mfmaIndex:12  */
s_waitcnt lgkmcnt(14)                              // wait for prior local read local write old=4, new=14 newLW=10 newLR=0
/* pack scheduling: packAIdx:2, packBIdx:0 */
...
buffer_load_dword v[vgprG2LB+2+0], v[vgprGlobalReadOffsetB+1], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0 // load packed 2X half buffer value
/* g2l=2, load component 2 */
buffer_load_dword v[vgprG2LB+2+1], v[vgprGlobalReadOffsetB+1], s[sgprSrdB:sgprSrdB+3], 0 offen offset:4 // load packed 2X half buffer value
...
label_Summation_End_PLZIR8T5RF7DC6QQ_0:
/* endSummation: add vgpr [0...98) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_9GP97E3L9LMTJ1QQ_0   // Only branch on scc1
...
label_NoBranch_9GP97E3L9LMTJ1QQ_0:
