...
s_cbranch_scc0 label_NoBranch_VHIM81VTKL81G12R_0   // Only branch on scc1
...
label_NoBranch_VHIM81VTKL81G12R_0:
...
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+10+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+8+0], v64 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+8+0], v65 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+10+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+8+1], v64 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+8+1], v65 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+10+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+8+2], v64 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+8+2], v65 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+10+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+8+3], v64 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+8+3], v65 dst_sel:WORD_1  // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrB], v[vgprG2LB+8:vgprG2LB+8+3] offset:2304 // lwoB_0_0_2_0 = (0*LSCB)*(MT1J+PAD) + (2*LSPB) = 2304
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+14+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+12+0], v64 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+12+0], v65 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+14+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+12+1], v64 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+12+1], v65 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+14+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+12+2], v64 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+12+2], v65 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[64:65], v[vgprG2LB+14+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LB+12+3], v64 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LB+12+3], v65 dst_sel:WORD_1 // Convert to FP16
...
label_Summation_End_AIM7K4Q6E72HUS8R_0:
/* endSummation: add vgpr [0...62) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_L6I0I4CW639FVKXQ_0   // Only branch on scc1
...
label_NoBranch_L6I0I4CW639FVKXQ_0:
