...
s_cbranch_scc0 label_NoBranch_OJUF0LY4Q0NJ9YT4_0   // Only branch on scc1
...
label_NoBranch_OJUF0LY4Q0NJ9YT4_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[50:51], v[vgprG2LA+1+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+0], v50 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+0], v51 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[50:51], v[vgprG2LA+1+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+1], v50 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+1], v51 dst_sel:WORD_1  // Convert to FP16
ds_write_b64 v[vgprLocalWriteAddrA], v[vgprG2LA+0:vgprG2LA+0+1] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
v_cvt_pk_f32_fp8 v[50:51], v[vgprG2LA+3+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+2+0], v50 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+2+0], v51 dst_sel:WORD_1  // Convert to FP16
v_cvt_pk_f32_fp8 v[50:51], v[vgprG2LA+3+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+2+1], v50 dst_sel:WORD_0  // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+2+1], v51 dst_sel:WORD_1  // Convert to FP16
...
label_Summation_End_98CU332KYA3WVH5S_0:
/* endSummation: add vgpr [0...48) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_3MPBQFVS1WROO161_0   // Only branch on scc1
...
label_NoBranch_3MPBQFVS1WROO161_0:
...
buffer_load_dword v52, v39, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
buffer_load_dword v52, v34, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_add_u32 s64, s64, s58
s_addc_u32 s65, s65, s59
s_cmp_eq_i32 s[sgprGSUSync], 0
