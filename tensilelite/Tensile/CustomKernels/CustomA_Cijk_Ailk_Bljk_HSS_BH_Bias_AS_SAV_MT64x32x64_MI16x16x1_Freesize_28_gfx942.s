...
s_mov_b32 m0, 0x7500                               // LDS clamp at 29952 bytes
...
s_mov_b32 s71, 4096                                // LSU offset: stride = lsuStride(64)*(MT0(64) + PAD0(0))
...
v_mov_b32 v12, s71                                 // edge vgpr = Size0I- WG*MT - margin(8)
...
s_cbranch_scc0 label_NoBranch_PNTZ0POQU4O1QUMB_0   // Only branch on scc1
...
label_NoBranch_PNTZ0POQU4O1QUMB_0:
...
s_cbranch_scc1 label_NoBranch_51OK3H9VCEIAAO9T_0   // Only branch on scc0
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_51OK3H9VCEIAAO9T_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_3H8E5086W77KT03O_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_3H8E5086W77KT03O_0:
...
s_cbranch_scc0 label_NoBranch_7A1ZXNPWB8HKUY06_0   // Only branch on scc1
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_7A1ZXNPWB8HKUY06_0:
...
s_cbranch_scc0 label_NoBranch_CUP2064ATU9NIONN_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_CUP2064ATU9NIONN_0:

s_and_b32 s73, 63, s[sgprSizesSum+0]               // s73 = s[sgprSizesSum+0] % 64
s_cmp_eq_u32 s73, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_0BKNX8AKQXK5G9IC_0   // Only branch on scc0
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_0BKNX8AKQXK5G9IC_0:
...
v_lshrrev_b32 v2, 6, v[vgprSerial]                 // v2 = v[vgprSerial] / 64
v_lshrrev_b32 v2, 2, v2                            // LSU offset: Get LSU wave_id
s_mov_b32 s5, 4096                                 // LSU offset: stride = lsuStride(64)*(MT0(64) + PAD0(0))
...
/* Tail: add address/G2L vgpr [32...52) to pool */
...
v_add_co_u32 v[vgprLocalReadAddrA], vcc, s5, v[vgprLocalReadAddrA] // lrA += 2112 ((MT+PAD)*bpe)
...
/* Tail: remove address/G2L [32...52) from pool */
label_Summation_End_SKRWC28AKB63E9UF_0:
/* endSummation: add vgpr [0...52) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_LZR9VHBAFWFQMFCL_0   // Only branch on scc1
...
label_NoBranch_LZR9VHBAFWFQMFCL_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
...
v_cndmask_b32 v30, v58, v30, s[76:77]              // LDD clip if OOB. offset
v_add_lshl_u32 v31, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v31, v58, v31, s[76:77]              // LDTD clip if OOB. offset
/* (d1,vc1,d0,vc0)=(1,0,0,0) */
...
v_cndmask_b32 v37, v58, v37, s[76:77]              // LDD clip if OOB. offset
v_add_lshl_u32 v38, v3, v0, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v38, v58, v38, s[76:77]              // LDTD clip if OOB. offset
...
v_cndmask_b32 v42, v58, v42, s[76:77]              // LDD clip if OOB. offset
v_add_lshl_u32 v43, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v43, v58, v43, s[76:77]              // LDTD clip if OOB. offset
...
v_cndmask_b32 v47, v58, v47, s[76:77]              // LDD clip if OOB. offset
v_add_lshl_u32 v48, v3, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v48, v58, v48, s[76:77]              // LDTD clip if OOB. offset
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v59, v30, v58, s[80:81]              // 1. mul 1 if 0
buffer_load_dword v60, v59, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
buffer_load_dword v60, v37, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v59, v37, v58, s[80:81]              // 1. mul 1 if 0
buffer_load_dword v60, v59, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
s_waitcnt vmcnt(14)                                // (wait for buffer ready)
v_add_f32 v46, v46, v60                            // buffer add
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 0
s_cmp_le_i32 s[sgprGSUSync], -14
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v59, v42, v58, s[80:81]              // 1. mul 1 if 0
buffer_load_dword v60, v59, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
buffer_load_dword v60, v47, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
s_sub_i32 s[sgprGSUSync], s[sgprGSUSync], 1        // 1
s_add_u32 s84, s84, s78
s_addc_u32 s85, s85, s79
s_cmp_eq_i32 s[sgprGSUSync], 0
...
s_addc_u32 s85, s85, s79
v_cmp_ge_i32 s[80:81], 0, s[sgprGSUSync]
v_cndmask_b32 v59, v47, v58, s[80:81]              // 1. mul 1 if 0
buffer_load_dword v60, v59, s[84:87], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cndmask_b32 v30, v58, v30, s[76:77]              // LDC clip if OOB. offset
...
v_cndmask_b32 v31, v58, v31, s[76:77]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v37, v58, v37, s[76:77]              // LDC clip if OOB. offset
buffer_load_dword v40, v37, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
s_mul_i32 s72, 64, s[sgprWorkGroup0]               // wgp0 * MT0
v_sub_u32 v38, v0, s72
v_lshlrev_b32 v38, 0x2, v38                        // Bias address scaled by BPE
v_cndmask_b32 v38, v58, v38, s[76:77]              // LDBias clip if OOB. offset
...
v_cndmask_b32 v42, v58, v42, s[76:77]              // LDC clip if OOB. offset
buffer_load_dword v45, v42, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
s_mul_i32 s72, 64, s[sgprWorkGroup0]               // wgp0 * MT0
v_sub_u32 v43, v4, s72
v_lshlrev_b32 v43, 0x2, v43                        // Bias address scaled by BPE
v_cndmask_b32 v43, v58, v43, s[76:77]              // LDBias clip if OOB. offset
...
/* MultipleBufferSingleKernel edge */
v_add_lshl_u32 v47, v2, v4, 0x2                    // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v47, v58, v47, s[76:77]              // LDC clip if OOB. offset
...
v_cndmask_b32 v48, v58, v48, s[76:77]              // LDBias clip if OOB. offset
