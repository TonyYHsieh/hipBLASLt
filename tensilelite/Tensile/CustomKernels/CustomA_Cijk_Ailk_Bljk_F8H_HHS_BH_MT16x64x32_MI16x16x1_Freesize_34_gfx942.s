...
s_cbranch_scc0 label_NoBranch_UFZB9XUSDCCIR8XD_0   // Only branch on scc1
...
label_NoBranch_UFZB9XUSDCCIR8XD_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[26:27], v[vgprG2LA+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0], v26 dst_sel:WORD_0    // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0], v27 dst_sel:WORD_1    // Convert to FP16
...
label_Summation_End_A1CKB0IL8VM15LRV_0:
/* endSummation: add vgpr [0...24) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_KRD4RMYP3P4CD1MC_0   // Only branch on scc1
...
label_NoBranch_KRD4RMYP3P4CD1MC_0:
