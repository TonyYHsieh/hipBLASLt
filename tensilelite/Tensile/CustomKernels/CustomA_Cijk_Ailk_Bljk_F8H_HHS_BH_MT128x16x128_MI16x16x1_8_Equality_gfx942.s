...
s_mul_i32 s51, s51, 32                             // Each wave loads continuous lsp(4)*nrp(8) columns
...
s_lshl_b32 s81, s80, 0                             // shift by StaggerUStride
...
s_cbranch_scc0 label_NoBranch_QF2S345RK3WITEMH_0   // Only branch on scc1
...
label_NoBranch_QF2S345RK3WITEMH_0:
...
label_Summation_End_B3YVRC6VMF1VN00W_0:
/* endSummation: add vgpr [0...94) to pool */
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_KIM8TRITCZ26H7CI_0   // Only branch on scc1
...
label_NoBranch_KIM8TRITCZ26H7CI_0:
...
buffer_load_dwordx2 v[96:97], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[104:105], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[112:113], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[120:121], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[128:129], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[136:137], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[144:145], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[152:153], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[160:161], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[168:169], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[176:177], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[184:185], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[192:193], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[200:201], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v18, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[208:209], v18, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
...
buffer_load_dwordx2 v[96:97], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[104:105], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[112:113], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[120:121], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[128:129], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[136:137], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[144:145], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[152:153], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[160:161], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[168:169], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[176:177], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[184:185], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[192:193], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[200:201], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[208:209], v23, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
...
buffer_load_dwordx2 v[96:97], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[104:105], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[112:113], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[120:121], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[128:129], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[136:137], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[144:145], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[152:153], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[160:161], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[168:169], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[176:177], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[184:185], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[192:193], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[200:201], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[66:67], 0, s[sgprGSUSync]
v_cndmask_b32 v26, v6, v9, s[66:67]                // 1. mul 1 if 0
buffer_load_dwordx2 v[208:209], v26, s[68:71], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
...
buffer_load_dwordx2 v[96:97], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[104:105], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[112:113], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[120:121], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[128:129], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[136:137], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[144:145], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[152:153], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[160:161], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[168:169], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[176:177], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[184:185], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[192:193], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[200:201], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[70:71], 0, s[sgprGSUSync]
v_cndmask_b32 v31, v6, v30, s[70:71]               // 1. mul 1 if 0
buffer_load_dwordx2 v[208:209], v31, s[72:75], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
