...
s_mov_b32 m0, 0x3540                               // LDS clamp at 13632 bytes
...
s_mul_i32 s71, s71, 4                              // Each wave loads continuous lsp(4)*nrp(1) columns
...
v_mov_b32 v10, s71                                 // edge vgpr = Size0I- WG*MT - margin(8)
v_min_i32 v6, v10, v6                              // offset = (offset < edge) ? offset(v6) : edge(v10)

/* global read addresses: final offsets a */
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+0,  6,  8, 24 // gROA_0_0_0_0

/* global read addresses: final offsets b */
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+0,  9,  7, 24 // gROB_0_0_0_0
...
s_cbranch_scc0 label_NoBranch_E2PLVUT0PIGCFVMM_0   // Only branch on scc1
...
label_NoBranch_E2PLVUT0PIGCFVMM_0:
...
s_cbranch_scc1 label_NoBranch_XUKTUZ0W86G8S5OP_0   // Only branch on scc0
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_XUKTUZ0W86G8S5OP_0:

s_cmp_eq_u32 s[sgprAlpha], 1.0                     // Alpha == 1.0 ?
s_cbranch_scc1 label_NoBranch_0C2PFR1V65LUBMAN_0   // Only branch on scc0
// branch if alpha != 1
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_0C2PFR1V65LUBMAN_0:
...
s_cbranch_scc0 label_NoBranch_J2B30S5D1TVD7JIW_0   // Only branch on scc1
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_J2B30S5D1TVD7JIW_0:
...
s_cbranch_scc0 label_NoBranch_GVHA2YBTXU13W6KH_0   // Only branch on scc1
// jump if edges required
s_getpc_b64 s[72:73]                               // addr of next instr
s_add_i32 s74, label_OptNLL_End, 0x4               // target branch offset
s_add_u32 s72, s72, s74                            // add target branch offset
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_GVHA2YBTXU13W6KH_0:

s_and_b32 s73, 31, s[sgprSizesSum+0]               // s73 = s[sgprSizesSum+0] % 32
s_cmp_eq_u32 s73, 0x0                              // numIterL == 0
s_cbranch_scc1 label_NoBranch_018UGR84Y0YG8P7F_0   // Only branch on scc0
...
s_addc_u32 s73, s73, 0                             // add high and carry
s_setpc_b64 s[72:73]                               // branch to label_OptNLL_End
label_NoBranch_018UGR84Y0YG8P7F_0:
...
/* endSummation: add vgpr [0...23) to pool */
/* load store sgprs */
...
/* Tail: add address/G2L vgpr [12...23) to pool */
...
/* Tail: remove address/G2L [12...23) from pool */
label_Summation_End_8IMC69LV101ZE5US_0:
/* endSummation: add vgpr [0...23) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 52 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_T0WNT1OAA8RVWM2G_0   // Only branch on scc1
...
label_NoBranch_T0WNT1OAA8RVWM2G_0:
s_mov_b32 s[sgprSrdScaleAlphaVec+0], s[sgprAddressScaleAlphaVec+0] // init SRD base address (lower)
s_mov_b32 s[sgprSrdScaleAlphaVec+1], s[sgprAddressScaleAlphaVec+1] // init SRD base address (upper) + other fields
s_mov_b32 s[sgprSrdScaleAlphaVec+3], Srd127_96     // Set bits 127_96 in post-loop SRD
s_cmp_eq_u64 s[sgprAddressScaleAlphaVec:sgprAddressScaleAlphaVec+1], 0 // s[AddressScaleAlphaVec] == 0 ?
...
v_add_f32 v4, v22, v[vgprValuC+25]                 // C += bias
s_swappc_b64 s[62:63], s[10:11]
v_mov_b32 v25, v4
...
v_cndmask_b32 v22, v34, v22, s[76:77]              // LDBias clip if OOB. offset
ds_read_b32 v25, v22 offset:0                      // load bias
