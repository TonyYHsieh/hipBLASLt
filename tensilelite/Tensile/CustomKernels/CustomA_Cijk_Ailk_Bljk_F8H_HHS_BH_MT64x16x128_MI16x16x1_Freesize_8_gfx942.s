...
s_mov_b32 s71, 8192                                // LSU offset: stride = lsuStride(128)*(MT0(64) + PAD0(0))
...
s_mul_i32 s71, s71, 32                             // Each wave loads continuous lsp(8)*nrp(4) columns
...
v_add_co_u32 v10, vcc, 8, v9                       // groAL_2 + LSPA
v_add_co_u32 v11, vcc, 8, v10                      // groAL_3 + LSPA
...
v_mov_b32 v13, s71                                 // edge vgpr = Size0I- WG*MT - margin(8)
...
s_cbranch_scc0 label_NoBranch_JFBA3B9PJS8RRNZ2_0   // Only branch on scc1
...
label_NoBranch_JFBA3B9PJS8RRNZ2_0:
...
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+4:vgprG2LA+4+3] offset:1056 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 1056
...
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+12:vgprG2LA+12+3] offset:3168 // lwoA_0_0_3_0 = (0*LSCA) + (3*LSPA)(*MT0I+PAD) = 3168
...
v_lshrrev_b32 v2, 6, v[vgprSerial]                 // v2 = v[vgprSerial] / 64
v_lshrrev_b32 v2, 2, v2                            // LSU offset: Get LSU wave_id
s_mov_b32 s5, 8192                                 // LSU offset: stride = lsuStride(128)*(MT0(64) + PAD0(0))
...
label_Summation_End_LPO2UFMCVS6SJ2YF_0:
/* endSummation: add vgpr [0...78) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_28V2EJUZC15RRFTU_0   // Only branch on scc1
...
label_NoBranch_28V2EJUZC15RRFTU_0:
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v88, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v92, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v96, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v100, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v104, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v108, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v112, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v116, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v120, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v124, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v128, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v132, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v19, v6, v18, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v136, v19, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v88, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v92, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v96, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v100, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v104, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v108, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v112, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v116, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v120, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v124, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v128, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v132, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
...
v_cmp_ge_i32 s[60:61], 0, s[sgprGSUSync]
v_cndmask_b32 v23, v6, v22, s[60:61]               // 1. mul 1 if 0
buffer_load_dword v136, v23, s[64:67], 0 offen offset:0, sc0 sc1 // load GSU DD
// buffer add end
