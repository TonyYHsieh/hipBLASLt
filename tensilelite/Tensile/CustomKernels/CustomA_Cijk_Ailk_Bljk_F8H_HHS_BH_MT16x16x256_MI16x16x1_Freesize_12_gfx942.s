...
.set vgprG2LA, 114
.set vgprG2LB, 146
.set vgprLocalReadAddrA, 178
.set vgprLocalReadAddrB, 179
.set vgprSerial, 180
...
s_mov_b32 s71, 4096                                // LSU offset: stride = lsuStride(256)*(MT0(16) + PAD0(0))
...
s_mul_i32 s71, s71, 256                            // Each wave loads continuous lsp(32)*nrp(8) columns
...
v_readfirstlane_b32 s71, v[vgprSerial]             // WaveIdxWavefrontWidth
s_lshr_b32 s71, s71, 0x6                           // WaveId
s_mul_i32 s71, s71, 16                             // Each wave loads continuous lsp(2)*nrp(8) columns
...
v_add_co_u32 v16, vcc, 32, v15                     // groAL_1 + LSPA
v_add_co_u32 v17, vcc, 32, v16                     // groAL_2 + LSPA
v_add_co_u32 v18, vcc, 32, v17                     // groAL_3 + LSPA
v_add_co_u32 v19, vcc, 32, v18                     // groAL_4 + LSPA
v_add_co_u32 v20, vcc, 32, v19                     // groAL_5 + LSPA
v_add_co_u32 v21, vcc, 32, v20                     // groAL_6 + LSPA
v_add_co_u32 v22, vcc, 32, v21                     // groAL_7 + LSPA
...
v_mov_b32 v24, s71                                 // edge vgpr = Size0I- WG*MT - margin(8)
v_min_i32 v6, v24, v6                              // offset = (offset < edge) ? offset(v6) : edge(v24)

/* global read addresses: final offsets a */
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+0,  6, 15, 24 // gROA_0_0_0_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+1,  6, 16, 24 // gROA_0_0_1_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+2,  6, 17, 24 // gROA_0_0_2_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+3,  6, 18, 24 // gROA_0_0_3_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+4,  6, 19, 24 // gROA_0_0_4_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+5,  6, 20, 24 // gROA_0_0_5_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+6,  6, 21, 24 // gROA_0_0_6_0
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+7,  6, 22, 24 // gROA_0_0_7_0

/* global read addresses: final offsets b */
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+0, 23,  7, 15 // gROB_0_0_0_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+1, 23,  8, 15 // gROB_0_0_1_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+2, 23,  9, 15 // gROB_0_0_2_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+3, 23, 10, 15 // gROB_0_0_3_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+4, 23, 11, 15 // gROB_0_0_4_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+5, 23, 12, 15 // gROB_0_0_5_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+6, 23, 13, 15 // gROB_0_0_6_0
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+7, 23, 14, 15 // gROB_0_0_7_0
...
s_cbranch_scc0 label_NoBranch_6FZHSAU5UZLQ9JCQ_0   // Only branch on scc1
...
label_NoBranch_6FZHSAU5UZLQ9JCQ_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read

/* local write a */
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+2+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+0], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+0], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+2+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+1], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+1], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+2+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+2], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+2], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+2+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+0+3], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+0+3], v183 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+0:vgprG2LA+0+3] offset:0 // lwoA_0_0_0_0 = (0*LSCA) + (0*LSPA)(*MT0I+PAD) = 0
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+6+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+0], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+0], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+6+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+1], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+1], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+6+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+2], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+2], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+6+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+4+3], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+4+3], v183 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+4:vgprG2LA+4+3] offset:1152 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 1152
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+10+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+0], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+0], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+10+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+1], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+1], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+10+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+2], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+2], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+10+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+8+3], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+8+3], v183 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+8:vgprG2LA+8+3] offset:2304 // lwoA_0_0_2_0 = (0*LSCA) + (2*LSPA)(*MT0I+PAD) = 2304
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+14+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+0], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+0], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+14+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+1], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+1], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+14+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+2], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+2], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+14+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+12+3], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+12+3], v183 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+12:vgprG2LA+12+3] offset:3456 // lwoA_0_0_3_0 = (0*LSCA) + (3*LSPA)(*MT0I+PAD) = 3456
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+18+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+16+0], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+16+0], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+18+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+16+1], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+16+1], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+18+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+16+2], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+16+2], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+18+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+16+3], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+16+3], v183 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+16:vgprG2LA+16+3] offset:4608 // lwoA_0_0_4_0 = (0*LSCA) + (4*LSPA)(*MT0I+PAD) = 4608
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+22+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+20+0], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+20+0], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+22+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+20+1], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+20+1], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+22+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+20+2], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+20+2], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+22+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+20+3], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+20+3], v183 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+20:vgprG2LA+20+3] offset:5760 // lwoA_0_0_5_0 = (0*LSCA) + (5*LSPA)(*MT0I+PAD) = 5760
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+26+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+24+0], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+24+0], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+26+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+24+1], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+24+1], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+26+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+24+2], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+24+2], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+26+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+24+3], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+24+3], v183 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+24:vgprG2LA+24+3] offset:6912 // lwoA_0_0_6_0 = (0*LSCA) + (6*LSPA)(*MT0I+PAD) = 6912
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+30+0] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+28+0], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+28+0], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+30+0] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+28+1], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+28+1], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+30+1] src0_sel:WORD_0 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+28+2], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+28+2], v183 dst_sel:WORD_1 // Convert to FP16
v_cvt_pk_f32_fp8 v[182:183], v[vgprG2LA+30+1] src0_sel:WORD_1 // convert to F32
v_cvt_f16_f32 v[vgprG2LA+28+3], v182 dst_sel:WORD_0 // Convert to FP16
v_cvt_f16_f32 v[vgprG2LA+28+3], v183 dst_sel:WORD_1 // Convert to FP16
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+28:vgprG2LA+28+3] offset:8064 // lwoA_0_0_7_0 = (0*LSCA) + (7*LSPA)(*MT0I+PAD) = 8064
...
/* endSummation: add vgpr [0...180) to pool */
/* load store sgprs */
/* load store sgprs2 */
...
v_lshrrev_b32 v2, 6, v[vgprSerial]                 // v2 = v[vgprSerial] / 64
v_lshrrev_b32 v2, 0, v2                            // LSU offset: Get LSU wave_id
s_mov_b32 s5, 4096                                 // LSU offset: stride = lsuStride(256)*(MT0(16) + PAD0(0))
...
/* Tail: add address/G2L vgpr [96...180) to pool */
...
/* Tail: remove address/G2L [96...180) from pool */
label_Summation_End_L4NPZHIG4F79WWDZ_0:
/* endSummation: add vgpr [0...180) to pool */
.set sgprWGM, UNDEF
...
s_waitcnt lgkmcnt(0)                               // wait for 16 bytes of kern args.
s_cmp_eq_u32 s[sgprGSU], 1                         // GSU == 1 ?
s_cbranch_scc0 label_NoBranch_SRUU3GTGQJZWERB7_0   // Only branch on scc1
...
label_NoBranch_SRUU3GTGQJZWERB7_0:
